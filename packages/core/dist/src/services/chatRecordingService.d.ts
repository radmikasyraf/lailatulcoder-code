...
import type { PartListUnion, Content, FunctionDeclaration, GenerateContentResponseUsageMetadata } from '@google/genai';
...
import type { FileHistorySnapshot, SerializedFileHistorySnapshot } from './fileHistoryService.js';
import type { SessionArtifactEventRecordPayload, SessionArtifactSnapshotRecordPayload } from './session-artifact-persistence.js';
import { type SessionWriterLease } from './session-writer-lease.js';
import type { GoalStateRecordPayloadV2, GoalTurnPermit, TranscriptCursor } from '../goals/goal-protocol.js';
import { type BranchCheckpointRecordPayloadV1, type BranchPoint, type BranchToolCallIdentity } from './branch-points.js';
 ...
 */
export type ChatRecordProvenance = 'real_user' | 'assistant_output' | 'tool_result' | 'goal_control' | 'goal_runtime' | 'system';
...
export interface ChatRecord {
    ...
    subtype?: 'chat_compression' | 'slash_command' | 'ui_telemetry' | 'at_command' | 'attribution_snapshot' | 'notification' | 'cron' | 'mid_turn_user_message' | 'custom_title' | 'parent_session' | 'session_source' | 'rewind' | 'agent_bootstrap' | 'agent_launch_prompt' | 'agent_retry' | 'file_history_snapshot' | 'user_text_elements' | 'session_artifact_event' | 'session_artifact_snapshot' | 'branch_checkpoint' | 'goal_state' | 'goal_runtime' | 'realtime_message' | 'turn_result';
     ...
     */
    systemPayload?: ChatCompressionRecordPayload | SlashCommandRecordPayload | UiTelemetryRecordPayload | AtCommandRecordPayload | AttributionSnapshotPayload | CustomTitleRecordPayload | ParentSessionRecordPayload | SessionSourceRecordPayload | NotificationRecordPayload | UserPromptRecordPayload | RewindRecordPayload | AgentBootstrapRecordPayload | AgentRetryRecordPayload | FileHistorySnapshotRecordPayload | UserTextElementsRecordPayload | SessionArtifactEventRecordPayload | SessionArtifactSnapshotRecordPayload | BranchCheckpointRecordPayloadV1 | GoalStateRecordPayloadV2 | TurnResultRecordPayload;
 ...
 */
export declare const TURN_RESULT_TEXT_MAX_CHARS = 32768;
export declare const TURN_RESULT_ERROR_MESSAGE_MAX_CHARS = 4096;
export declare const TURN_RESULT_ERROR_CODE_MAX_CHARS = 256;
export declare const TURN_RESULT_IDENTIFIER_MAX_CHARS = 256;
export declare const TURN_RESULT_CODE_TEXT_TRUNCATED: "RESULT_TEXT_TRUNCATED";
...
export declare function normalizeTurnResultError(error: unknown): TurnResultErrorPayload;
/**
...
export declare function isTurnResultRecordPayload(value: unknown): value is TurnResultRecordPayload;
export interface ChatRecordingFailureEvent {
    sessionId: string;
    error: Error;
}
export type ChatRecordingFailureListener = (event: ChatRecordingFailureEvent) => void | Promise<void>;
...
export declare class ChatRecordingService {
    ...
    constructor(config: Config, onWriteFailure?: ChatRecordingFailureListener | undefined, writerLeaseRequired?: boolean, restoreState?: ChatRecordingRestoreState);
    ...
    activate(lease: SessionWriterLease, sessionData?: {
        conversation: {
            messages: ChatRecord[];
        };
        ...
        title?: string;
        source?: TitleSource;
    }, restoreState?: ChatRecordingRestoreState): void;
    /**
    ...
    recordGoalState(recordUuid: string, payload: GoalStateRecordPayloadV2): Promise<ChatRecord>;
    /**
     ...
     */
    recordUserMessage(message: PartListUnion, goalContext?: GoalTurnPermit, promptPayload?: UserPromptRecordPayload): void;
    getUserDisplayTextsForTitle(): ReadonlyArray<string | undefined>;
    recordGoalRuntimeMessage(message: PartListUnion, goalContext: GoalTurnPermit): void;
    /**
     ...
     */
    recordMidTurnUserMessage(message: PartListUnion, displayText: string, goalContext?: GoalTurnPermit, attachmentReferences?: UserPromptAttachmentReference[]): void;
    /**
     ...
     */
    recordCronPrompt(message: PartListUnion, displayText?: string, goalContext?: GoalTurnPermit): void;
    /**
     ...
     */
    recordNotification(message: PartListUnion, displayText?: string, backgroundTask?: NotificationRecordPayload['backgroundTask'], goalContext?: GoalTurnPermit): void;
    /**
     ...
     */
    recordNotificationStrict(message: PartListUnion, displayText?: string, backgroundTask?: NotificationRecordPayload['backgroundTask']): Promise<void>;
    ...
    recordRealtimeConversation(entries: ReadonlyArray<{
        role: 'user' | 'assistant';
        text: string;
    ...
    recordToolResult(message: PartListUnion, toolCallResult?: Partial<ToolCallResponseInfo> & {
        status: Status;
    }, options?: RecordToolResultOptions): void;
    /**
     ...
     */
    rewindRecording(targetTurnIndex: number, payload: RewindRecordPayload, survivingFileHistorySnapshots?: FileHistorySnapshot[]): void;
    /**
    ...
    setTitleRecordedCallback(callback: ((customTitle: string, titleSource: TitleSource, sessionId: string) => void) | undefined): void;
    /**
     ...
     */
    getTitleRecordedCallback(): ((customTitle: string, titleSource: TitleSource, sessionId: string) => void) | undefined;
    /**
     ...
     */
    recordCustomTitle(customTitle: string, titleSource?: TitleSource): Promise<boolean>;
    ...
    recordSessionArtifactEvent(payload: SessionArtifactEventRecordPayload): Promise<void>;
    recordSessionArtifactSnapshot(payload: SessionArtifactSnapshotRecordPayload): Promise<void>;
}
