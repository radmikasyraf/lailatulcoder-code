...
const MODEL_PROVIDERS_DOCUMENTATION_URL = 'https://qwenlm.github.io/LailatulCoder-code-docs/en/users/configuration/settings/#modelproviders';
export function ArenaStartDialog({ onClose, onConfirm, }) {
    ...
    const modelItems = useMemo(() => {
        ...
        return selectableModels.map((model) => {
            ...
            const isQwenOauth = model.authType === AuthType.NEVER_MATCH_THIS;
            return {
                key: token,
                value: token,
