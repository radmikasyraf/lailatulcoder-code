 ...
 */
export function iconvDecode(buffer, encoding) {
 ...
 */
export function iconvEncode(content, encoding) {
 ...
 */
export function iconvEncodingExists(encoding) {
    return iconvLite.encodingExists(encoding);
}
//# sourceMappingURL=iconvHelper.js.map