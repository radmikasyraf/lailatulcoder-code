...
import type { DeviceFlowProvider, DeviceFlowRegistry } from './auth/device-flow.js';
...
import { type ManagedScratchRoot, type WorkspaceRuntimeProvenance } from './managed-scratch-workspace.js';
...
import type { ChannelDeliveryAccepted, ChannelDeliveryRequest } from '../runtime/channel-delivery-ipc.js';
...
import { type ServeAppLifecycleController } from './serve-app-lifecycle.js';
...
export interface ServeAppDeps {
    ...
    deliverChannelMessage?: (workspaceCwd: string, request: ChannelDeliveryRequest) => Promise<ChannelDeliveryAccepted>;
    ...
    channelManagementService?: (runtime: WorkspaceRuntime) => ChannelManagementService | undefined | Promise<ChannelManagementService | undefined>;
    ...
    persistSetting?: (workspace: string, scope: import('../config/settings.js').SettingScope, key: string, value: unknown, assertGenerationOpen?: () => void) => Promise<void | import('../config/settings.js').LoadedSettings>;
    persistSettings?: (workspace: string, writes: Array<{
        scope: import('../config/settings.js').SettingScope;
        key: string;
        value: unknown;
    }>, assertGenerationOpen?: () => void) => Promise<void>;
    ...
    createWorkspaceRuntime?: (cwd: string, options: {
        provenance: WorkspaceRuntimeProvenance;
    }) => Promise<WorkspaceRuntime>;
    managedScratchRoot?: ManagedScratchRoot;
    validateWorkspaceRuntimeForPublication?: (runtime: WorkspaceRuntime) => Promise<WorkspaceRuntime>;
    ...
    conversationRuntimeOwnershipFactory?: (pid: number, instanceNonce: string, stableBaseDir: string) => ConversationRuntimeOwnership;
    serveAppLifecycle?: ServeAppLifecycleController;
    validateLiveProviderCredential?: (credential: LiveProviderCredential) => Promise<void>;
}
/**
