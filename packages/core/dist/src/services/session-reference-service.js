    ...
    deriveTitle(records) {
        ...
        for (const rec of records) {
            if (rec.type === 'system' && rec.subtype === 'custom_title') {
                const payload = rec.systemPayload;
...
//# sourceMappingURL=session-reference-service.js.map