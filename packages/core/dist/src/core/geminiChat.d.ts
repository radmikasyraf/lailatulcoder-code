 ...
 */
export declare function redactApprovedPlansInHistory(history: Content[], savedPlanContent: string, planPath: string): Content[] | null;
/**
...
export declare class GeminiChat {
     ...
     */
    seedResumeTokenCounts(promptTokenCount: number, outputTokenCount: number, isEstimated?: boolean): void;
    /**
     ...
     */
    tryCompress(promptId: string, force?: boolean, signal?: AbortSignal, options?: TryCompressOptions): Promise<ChatCompressionInfo>;
    /**
     ...
     * ```
     */
    sendMessageStream(model: string, params: SendMessageParameters, prompt_id: string, goalContext?: GoalTurnPermit, options?: GeminiChatSendOptions): Promise<AsyncGenerator<StreamEvent>>;
    /**
     ...
     */
    redactApprovedPlanFromHistory(callId: string, replacement: string, expectedPlan?: string): boolean;
    /**
