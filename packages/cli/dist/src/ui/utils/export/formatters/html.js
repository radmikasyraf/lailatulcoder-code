 ...
 */
import { EXPORT_HTML_TEMPLATE as HTML_TEMPLATE } from '@lailatul-coder/web-templates';
/**
 ...
 */
export function injectDataIntoHtmlTemplate(template, data) {
 ...
 */
export function toHtml(sessionData) {
