 ...
 */
import type { ModelProvidersConfig, ProviderProtocolConfig } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export declare function removeModelFromProviders(modelProviders: ModelProvidersConfig, providerProtocol: ProviderProtocolConfig | undefined, target: RemoveModelTarget): RemoveModelResult;
/**
 ...
 */
export declare function isActiveModelSelection(activeModelName: string | undefined, activeBaseUrl: string | undefined, target: RemoveModelTarget): boolean;
