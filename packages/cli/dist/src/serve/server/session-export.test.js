...
import { SESSION_TRANSCRIPT_MAX_INDEX_BYTES, SessionService, } from '@lailatul-coder/lailatul-coder-core';
...
describe('exportSessionTranscript', () => {
    ...
    it('loads active storage when archiveState is omitted', async () => {
        const loadArchivedSession = vi.spyOn(SessionService.prototype, 'loadArchivedSession');
...
//# sourceMappingURL=session-export.test.js.map