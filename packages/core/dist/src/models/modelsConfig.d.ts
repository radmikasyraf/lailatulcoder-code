...
import { type ModelProvidersConfig, type ProviderProtocolConfig, type ResolvedModelConfig, type AvailableModel, type ModelSwitchMetadata, type RuntimeModelSnapshot } from './types.js';
...
export declare class ModelsConfig {
     ...
     */
    getResolvedModel(authType: AuthType, modelId: string, baseUrl?: string): ResolvedModelConfig | undefined;
    /**
     ...
     */
    syncAfterAuthRefresh(authType: AuthType, modelId?: string, providerBaseUrlOverride?: string): void;
    /**
