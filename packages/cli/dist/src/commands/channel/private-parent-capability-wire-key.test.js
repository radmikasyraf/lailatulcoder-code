...
import { ACP_PRIVATE_PARENT_CAPABILITY_ENV, ACP_PRIVATE_PARENT_CAPABILITY_META_KEY, } from '@lailatul-coder/channel-base';
import { PRIVATE_ACP_CAPABILITY_ENV, PRIVATE_PARENT_CAPABILITY_META_KEY, } from '@lailatul-coder/lailatul-coder-core';
...
describe('private parent capability wire keys', () => {
    it('are identical across channel-base and core', () => {
        expect(ACP_PRIVATE_PARENT_CAPABILITY_META_KEY).toBe(PRIVATE_PARENT_CAPABILITY_META_KEY);
        expect(ACP_PRIVATE_PARENT_CAPABILITY_ENV).toBe(PRIVATE_ACP_CAPABILITY_ENV);
    });
});
//# sourceMappingURL=private-parent-capability-wire-key.test.js.map