 ...
 */
import { type DurableCronTask } from '@lailatul-coder/lailatul-coder-core';
...
export declare function startScheduledTaskKeepalive(opts: StartScheduledTaskKeepaliveOptions): ScheduledTaskKeepalive;
