 ...
 */
import type { SessionListItem as SessionData, SessionService } from '@lailatul-coder/lailatul-coder-core';
...
export declare function SessionPicker(props: SessionPickerProps): import("react").JSX.Element;
