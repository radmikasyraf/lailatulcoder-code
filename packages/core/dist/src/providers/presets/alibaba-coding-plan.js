...
export const CODING_PLAN_CHINA_BASE_URL = 'https://coding.dashscope.aliyuncs.com/v1';
export const CODING_PLAN_GLOBAL_BASE_URL = 'https://coding-intl.dashscope.aliyuncs.com/v1';
const MODELSTUDIO_MODELS = [
    {
        id: 'qwen3.5-plus',
...
// Provider config
// ---------------------------------------------------------------------------
export const codingPlanProvider = {
    id: 'coding-plan',
    label: 'Coding Plan',
    ...
    modelsEditable: true,
    modelNamePrefix: (baseUrl) => baseUrl === CODING_PLAN_GLOBAL_BASE_URL
        ? 'ModelStudio Coding Plan for Global/Intl'
        : 'ModelStudio Coding Plan',
    apiKeyPlaceholder: 'sk-sp-...',
    validateApiKey: (key) => !key.startsWith('sk-sp-')
        ? 'Invalid API key. Coding Plan API keys start with "sk-sp-". Please check.'
        : null,
    ownsModel: (model) => model.envKey === CODING_PLAN_ENV_KEY &&
