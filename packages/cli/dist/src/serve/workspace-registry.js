...
export function createWorkspaceRegistry(inputRuntimes, options = {}) {
    ...
    return {
        ...
        listEntries: () => Object.freeze(entries.filter((entry) => entry.state !== 'removed' && !entry.internal)),
        listAll: () => Object.freeze(entries.flatMap((entry) => {
            const runtime = activeRuntime(entry);
            return runtime ? [runtime] : [];
        })),
        listAllEntries: () => Object.freeze(entries.filter((entry) => entry.state !== 'removed')),
