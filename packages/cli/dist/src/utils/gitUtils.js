...
export const getLatestGitHubRelease = async (proxy) => {
    try {
        ...
        const endpoint = `https://api.github.com/repos/LailatulCoder/lailatul-coder-action/releases/latest`;
        ...
        debugLogger.debug(`Failed to determine latest lailatul-coder-action release:`, _error);
        throw new Error(`Unable to determine the latest lailatul-coder-action release on GitHub.`);
    }
};
