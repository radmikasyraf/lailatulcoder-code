 ...
 */
import { AuthType, type Config, type ProviderConfig, type ProviderSetupInputs } from '@lailatul-coder/lailatul-coder-core';
...
export declare const useAuthCommand: (settings: LoadedSettings, config: Config, addItem: (item: HistoryItemWithoutId, timestamp: number) => void, onAuthChange?: () => void) => {
    authState: AuthState;
