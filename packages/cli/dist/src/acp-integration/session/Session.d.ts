...
import type { Config, ChatRecord, HistoryGap, AutoModeDecision, AutoModeOutcome, GoalTurnPermit, InvocationContextV1 } from '@lailatul-coder/lailatul-coder-core';
import { LoopType } from '@lailatul-coder/lailatul-coder-core';
import { type ActiveWorkHoldV1 } from '@lailatul-coder/acp-bridge/bridgeTypes';
...
export declare const LOOP_DETECTED_TURN_ERROR_MESSAGE = "Tool-call loop protection stopped this turn. The session is still available; send a more specific instruction to continue.";
...
export declare class Session implements SessionContext {
    ...
    private readonly runExclusiveAutomaticHistoryMutation;
    /**
    ...
    private currentShellNotificationActive;
    ...
    private suppressedRecoveredGoalId?;
    private goalPublicationTail;
    private disposed;
    private closing;
    private historyMutationActive;
    ...
    constructor(id: string, config: Config, client: AgentSideConnection, settings: LoadedSettings, runExclusiveAutomaticHistoryMutation?: HistoryMutationRunner, 
    /**
     * Invoked whenever work this Session owns may have started or finished.
     * The owner (one reporter per ACP channel) coalesces these and republishes
     * a full snapshot; the Session itself keeps no reporting state.
    ...
    primeRecoveredGoalPublication(publicationKey: string | undefined, suppressedGoalId?: string): void;
    ...
    primeTurnState(initialTurn: number, backgroundNotificationTaskIds: readonly string[]): void;
    replayHistory(records: ChatRecord[], gaps?: HistoryGap[], options?: Parameters<HistoryReplayer['replay']>[2]): Promise<void>;
