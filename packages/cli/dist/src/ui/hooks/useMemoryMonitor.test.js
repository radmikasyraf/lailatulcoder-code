...
import { useMemoryMonitor, MEMORY_CHECK_INTERVAL, MEMORY_WARNING_THRESHOLD, MEMORY_UI_COMPACT_THRESHOLD, MEMORY_DEBUG_INTERVAL, UI_COMPACT_COOLDOWN_MS, } from './useMemoryMonitor.js';
...
describe('useMemoryMonitor', () => {
    ...
    it('continues interval when compactOldItems throws', () => {
        ...
        expect(mockDebugLogger.error).toHaveBeenCalledWith(expect.stringContaining('compactOldItems failed: compact boom'));
