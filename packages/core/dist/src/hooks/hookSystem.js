...
export class HookSystem {
    ...
    async fireUserPromptSubmitEvent(prompt, signal, submittedPrompt) {
        const result = await this.hookEventHandler.fireUserPromptSubmitEvent(prompt, signal, submittedPrompt);
    ...
    async fireInstructionsLoadedEvent(filePath, memoryType, loadReason, options = {}, signal) {
        const result = await this.hookEventHandler.fireInstructionsLoadedEvent(filePath, memoryType, loadReason, options, signal);
        return result.finalOutput
    ...
    async fireUserPromptExpansionEvent(commandName, commandArgs, prompt, signal) {
        const result = await this.hookEventHandler.fireUserPromptExpansionEvent(commandName, commandArgs, prompt, signal);
        return result.finalOutput
    ...
    async fireStopEvent(stopHookActive = false, lastAssistantMessage = '', contextUsage, signal) {
        return this.hookEventHandler.fireStopEvent(stopHookActive, lastAssistantMessage, contextUsage, signal);
    }
    /**
    ...
    async fireMessageDisplayEvent(messageId, displayedText, isFinal, signal) {
        return this.hookEventHandler.fireMessageDisplayEvent(messageId, displayedText, isFinal, signal);
    }
    ...
    async fireSessionDeleteEvent(deletedSessionId, signal) {
        const result = await this.hookEventHandler.fireSessionDeleteEvent(deletedSessionId, signal);
        return result.finalOutput
    ...
    async firePreToolUseEvent(toolName, toolInput, toolUseId, permissionMode, signal, tool_call_id) {
        const result = await this.hookEventHandler.firePreToolUseEvent(toolName, toolInput, toolUseId, permissionMode, signal, tool_call_id);
        return result.finalOutput
    ...
    async firePostToolUseEvent(toolName, toolInput, toolResponse, toolUseId, permissionMode, signal, tool_call_id) {
        const result = await this.hookEventHandler.firePostToolUseEvent(toolName, toolInput, toolResponse, toolUseId, permissionMode, signal, tool_call_id);
        return result.finalOutput
    ...
    async firePostToolUseFailureEvent(toolUseId, toolName, toolInput, errorMessage, isInterrupt, permissionMode, signal, tool_call_id) {
        const result = await this.hookEventHandler.firePostToolUseFailureEvent(toolUseId, toolName, toolInput, errorMessage, isInterrupt, permissionMode, signal, tool_call_id);
        return result.finalOutput
    ...
    async firePostToolBatchEvent(toolCalls, permissionMode = PermissionMode.Default, signal) {
        const result = await this.hookEventHandler.firePostToolBatchEvent(toolCalls, permissionMode, signal);
        return result.finalOutput
    ...
    async firePermissionDeniedEvent(toolName, toolInput, toolUseId, reason, signal, tool_call_id) {
        const result = await this.hookEventHandler.firePermissionDeniedEvent(toolName, toolInput, toolUseId, reason, signal, tool_call_id);
        return result.finalOutput
