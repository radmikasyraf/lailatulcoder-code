 ...
 */
import { ApprovalMode, DEFAULT_MAX_SUBAGENT_DEPTH, DEFAULT_MAX_TOOL_CALLS_PER_TURN, DEFAULT_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH, DEFAULT_QWEN_CUSTOM_IGNORE_FILE_NAMES, DEFAULT_STOP_HOOK_BLOCK_CAP, DEFAULT_TOOL_OUTPUT_BATCH_BUDGET, DEFAULT_TOOL_RESULTS_TOTAL_CHARS_THRESHOLD, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH_LIMIT, } from '@lailatul-coder/lailatul-coder-core';
...
const SETTINGS_SCHEMA = {
    ...
    serve: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Persistent LailatulCoder serve settings.',
        showInDialog: false,
        mergeStrategy: MergeStrategy.SHALLOW_MERGE,
        properties: {
            channels: {
    ...
    providerProtocol: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Maps a custom modelProviders provider id to the SDK protocol that routes its requests (e.g. {"idealab": "openai"}). Lets a custom provider id reuse a built-in protocol. Built-in provider ids (openai, gemini, anthropic, vertex-ai, LailatulCoder-oauth) are routed automatically and need no entry.',
        showInDialog: false,
        mergeStrategy: MergeStrategy.REPLACE,
    },
    plansDirectory: {
        ...
        requiresRestart: true,
        default: undefined,
        description: 'Custom directory for approved Plan Mode files. Relative paths are resolved from the project root, and the resolved path must stay within the project root. Defaults to ~/.lailatulcoder/plans.',
        showInDialog: false,
    },
    ...
    general: {
        ...
        properties: {
            ...
            voice: {
                ...
                properties: {
                    ...
                    keytermsFile: {
                        ...
                        requiresRestart: false,
                        default: '',
                        description: 'Path to a custom keyterms file (one term per line, "#" for comments) that biases voice transcription toward domain-specific terms. Relative paths resolve from the workspace root; defaults to ".lailatulcoder/voice-keyterms.txt" when present. The file contents are sent to the ASR provider and it is read only in trusted workspaces. Only applies to LailatulCoder ASR models (qwen3-asr-*).',
                        showInDialog: false,
                    },
                    refineTranscript: {
                        type: 'boolean',
            ...
            cleanupPeriodDays: {
                ...
                default: 30,
                minimum: 0,
                description: 'Number of days to retain ~/.lailatulcoder/file-history/ session backups used by /rewind and background subagent transcripts under <projectDir>/subagents/. Data older than this is removed by a background housekeeping pass that runs at most once per day. Set to 0 for minimum retention (~1 hour) — protects sessions touched in the last hour, plus the currently active session.',
                showInDialog: true,
            },
            gitCoAuthor: {
                type: 'object',
                ...
                description: 'Attribution added to git commits and pull requests created through LailatulCoder Ai.',
                showInDialog: false,
                ...
                // until they run LailatulCoder once. Config.normalizeGitCoAuthor handles
                ...
                properties: {
                    commit: {
                        ...
                        requiresRestart: false,
                        default: true,
                        description: 'Add a Co-authored-by trailer to git commit messages AND attach a per-file AI-attribution git note (`refs/notes/ai-attribution`) for commits made through LailatulCoder Ai. Disabling skips both.',
                        showInDialog: true,
                    },
                    pr: {
                        type: 'boolean',
                        ...
                        requiresRestart: false,
                        default: true,
                        description: 'Append a LailatulCoder Ai attribution line to PR descriptions when running `gh pr create`.',
                        showInDialog: true,
                    },
                },
            },
            ...
            language: {
                ...
                requiresRestart: true,
                default: 'auto',
                description: 'The language for the user interface. Use "auto" to detect from system settings. ' +
                    'You can also use custom language codes (e.g., "es", "fr") by placing JS language files ' +
                    'in ~/.lailatulcoder/locales/ (e.g., ~/.lailatulcoder/locales/es.js).',
                showInDialog: true,
                options: [],
            },
            outputLanguage: {
                ...
                requiresRestart: true,
                default: 'auto',
                description: 'The language for LLM output. Use "auto" to follow the user input language, ' +
            ...
            dynamicCommandTranslation: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Enable AI translation for dynamic slash command descriptions. ' +
            ...
            notificationMode: {
                ...
                requiresRestart: false,
                default: 'all',
                description: 'Which unfocused-terminal events fire a bell/OS notification. ' +
            ...
            preventSystemSleep: {
                ...
                requiresRestart: true,
                default: true,
                description: 'Prevent the system from sleeping while LailatulCoder Ai is streaming a model response or executing tools. Idle prompt time and permission prompts do not inhibit sleep.',
                showInDialog: true,
            },
            chatRecording: {
                type: 'boolean',
    ...
    dualOutput: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Dual-output sidecar mode: emit structured JSON events to a ' +
        ...
        properties: {
            jsonFile: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'File path for structured JSON event output. Equivalent to ' +
            ...
            inputFile: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'File path for remote input commands (JSONL). Equivalent to ' +
    ...
    ui: {
        ...
        properties: {
            ...
            showStatusInTitle: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Show LailatulCoder Ai session name and status in the terminal window title',
                showInDialog: true,
            },
            hideTips: {
                type: 'boolean',
            ...
            enableUserFeedback: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Show optional feedback dialog after conversations to help improve LailatulCoder performance.',
                showInDialog: true,
            },
            ...
            customBannerTitle: {
                ...
                requiresRestart: false,
                default: '',
                description: 'Replace the default ">_ LailatulCoder Ai" title shown in the banner info panel. The version suffix is always appended.',
                showInDialog: false,
            },
            ...
            customAsciiArt: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Replace the default LailatulCoder ASCII art. Accepts an inline string, {"path": "..."}, or {"small": ..., "large": ...} for width-aware selection.',
                showInDialog: false,
    ...
    advisorModel: {
        ...
        requiresRestart: false,
        default: '',
        description: 'Model used by /advisor for second-opinion reviews of the conversation. Leave empty to use the main model. A model at least as capable as the main model is recommended. Setting this sends the recent conversation transcript to that model, even when it uses another provider.',
        showInDialog: true,
    },
    visionModel: {
        type: 'string',
    ...
    compactionModel: {
        ...
        requiresRestart: false,
        default: '',
        description: 'Model used for chat compression (auto-compaction). Set with /model --compaction. Leave empty to fall back to the main model. A smaller/faster model reduces compression latency and cost.',
        showInDialog: false,
    },
    imageModel: {
        type: 'string',
        ...
        requiresRestart: false,
        default: '',
        description: 'Model used by the built-in image_gen tool. Set with /model --image. The selected model must be marked imageOnly in modelProviders.',
        showInDialog: false,
    },
    ...
    modelFallbacks: {
        ...
        requiresRestart: true,
        default: '',
        description: 'Ordered list of fallback model IDs (comma-separated, max 3) to try when the primary model hits capacity errors (429/503/529). Example: "LailatulCoder-plus,LailatulCoder-turbo". Set via CLI with --fallback-model.',
        showInDialog: true,
    },
    voiceModel: {
        type: 'string',
    ...
    model: {
        ...
        properties: {
            ...
            reasoningEffort: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'How hard reasoning-capable models think, applied across all providers. Set with /effort. Each provider maps and clamps this to what the active model supports (e.g. Gemini caps at "high"; Anthropic clamps tiers a model lacks). Leave unset to use the model/provider default.',
                showInDialog: true,
                options: [
                    { value: 'low', label: 'Low' },
                    { value: 'medium', label: 'Medium' },
            ...
            maxSessionTurns: {
                ...
                requiresRestart: false,
                default: -1,
                description: 'Maximum number of user/model/tool turns to keep in a session. Must be an integer; -1 means unlimited.',
                showInDialog: false,
            },
            maxWallTimeSeconds: {
                type: 'number',
            ...
            generationConfig: {
                ...
                properties: {
                    ...
                    forceGlobalCacheScope: {
                        ...
                        requiresRestart: false,
                        default: false,
                        description: "Force scope:'global' on Anthropic cache_control entries even when the base URL is not an Anthropic-native origin (e.g. proxy providers like Routify, OpenRouter). Requires the proxy to forward cache_control fields and the prompt-caching-scope-2026-01-05 beta.",
                        parentKey: 'generationConfig',
                        showInDialog: false,
                    },
                    cacheRetention: {
                    ...
                    toolResultContentFormat: {
                        ...
                        requiresRestart: false,
                        default: 'parts',
                        description: 'Controls how text-only tool results are serialized in OpenAI-compatible requests. Use "parts" for the default content-part array shape. Use "string" only for legacy OpenAI-compatible runtimes whose tool templates ignore text content parts (for example older GLM-5.1 vLLM/SGLang templates; LailatulCoder/lailatul-coder#3361). Tool-returned media is still handled by splitToolMedia.',
                        parentKey: 'generationConfig',
                        showInDialog: false,
                        options: [
                    ...
                    contextWindowSize: {
                        ...
                        requiresRestart: false,
                        default: undefined,
                        description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from LailatulCoder Ai's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
                        parentKey: 'generationConfig',
                        showInDialog: false,
                    },
                },
        ...
        properties: {
            ...
            clearContextOnIdle: {
                ...
                properties: {
                    ...
                    toolResultsTotalCharsThreshold: {
                        ...
                        description: 'Total compactable tool result output characters allowed in history before clearing oldest results. When exceeded, oldest results are cleared down to half this threshold (best effort) to preserve the provider prompt cache on later turns. Use -1 to disable. This is a soft threshold: protected recent tool results may keep the total above it.',
                        showInDialog: false,
                    },
                },
            },
            fileFiltering: {
                ...
                properties: {
                    ...
                    respectQwenIgnore: {
                        type: 'boolean',
                        label: 'Respect .lailatulcoderignore',
                        category: 'Context',
                        requiresRestart: true,
                        default: true,
                        description: 'Respect .lailatulcoderignore and configured custom ignore files when searching',
                        showInDialog: true,
                    },
                    customIgnoreFiles: {
                        type: 'array',
                        ...
                        description: 'Project-root-relative ignore files to use instead of the defaults (`.agentignore`, `.aiignore`) when respectQwenIgnore is enabled. .lailatulcoderignore is always included when respectQwenIgnore is enabled.',
                        showInDialog: false,
                        items: { type: 'string' },
                    },
    ...
    memory: {
        ...
        properties: {
            ...
            enableTeamMemory: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Enable a project memory tier shared with collaborators via the git-tracked `.lailatulcoder/team-memory/` directory. Off by default; writes to it are secret-scanned and reviewable in the git diff.',
                showInDialog: false,
            },
            enableTeamMemorySync: {
                ...
                requiresRestart: false,
                default: false,
                description: 'When team memory is enabled, automatically commit, fast-forward-pull, and push the `.lailatulcoder/team-memory/` directory at session start so collaborators stay in sync. Off by default; requires a configured git upstream.',
                showInDialog: false,
            },
        },
    },
    slashCommands: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Configuration for slash commands exposed by the CLI. Useful for ' +
        ...
        properties: {
            disabled: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Slash command names to hide and refuse to execute. Matched ' +
    ...
    skills: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Configuration for skills (SKILL.md-based capabilities) exposed to ' +
            'the model.',
        showInDialog: false,
        properties: {
            disabledLevels: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Skill discovery levels to skip entirely. Supported levels are ' +
            ...
            disabled: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Skill names to hide. Matched case-insensitively against the skill ' +
            ...
            defaultDisabled: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Skill names disabled by default unless explicitly enabled through ' +
            ...
            enabled: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Explicit opt-ins that override matching skills.defaultDisabled ' +
            ...
            directories: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Additional directories to scan for skills (SKILL.md files). ' +
    ...
    permissions: {
        ...
        properties: {
            allow: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Tools or commands that are auto-approved without confirmation. ' +
            ...
            ask: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Tools or commands that always require user confirmation. ' +
            ...
            autoMode: {
                ...
                properties: {
                    ...
                    hints: {
                        ...
                        properties: {
                            ...
                            softDeny: {
                                ...
                                requiresRestart: true,
                                default: undefined,
                                description: 'Natural-language descriptions of destructive / irreversible ' +
                            ...
                            hardDeny: {
                                ...
                                requiresRestart: true,
                                default: undefined,
                                description: 'Natural-language descriptions of security-boundary actions ' +
                            ...
                            deny: {
                                ...
                                requiresRestart: true,
                                default: undefined,
                                description: 'Deprecated alias for `softDeny`. Entries here are merged ' +
                    ...
                    classifyAllShell: {
                        ...
                        requiresRestart: true,
                        default: false,
                        description: 'Route ALL shell commands through the auto-mode classifier, ' +
    ...
    tools: {
        ...
        properties: {
            ...
            webSearch: {
                ...
                requiresRestart: true,
                default: {},
                description: 'Settings for the built-in WebSearch tool (DashScope Responses API backend). Opt-in: requires enabled=true and a search model. Fully env-configurable for environments without settings.json: ENABLE_WEB_SEARCH, WEB_SEARCH_MODEL, WEB_SEARCH_BASE_URL, WEB_SEARCH_API_KEY (falls back to DASHSCOPE_API_KEY), WEB_SEARCH_EXTRACTOR. Note: baseUrl and API key are env-only (WEB_SEARCH_BASE_URL / WEB_SEARCH_API_KEY) and cannot be set in settings.json.',
                showInDialog: false,
                properties: {
                    enabled: {
                        type: 'boolean',
                        ...
                        requiresRestart: true,
                        default: false,
                        description: 'Enable the built-in web_search tool. Also requires tools.webSearch.model. Env override: ENABLE_WEB_SEARCH.',
                        showInDialog: true,
                    },
                    model: {
                        type: 'string',
                        ...
                        requiresRestart: true,
                        default: undefined,
                        description: 'Model selector for the search side request, resolved against modelProviders like fastModel ("modelId" or "authType:modelId"). Must resolve to a DashScope-compatible entry with an envKey. Recommended: qwen3.6-plus. Env override: WEB_SEARCH_MODEL.',
                        showInDialog: true,
                    },
                    webExtractor: {
                        type: 'boolean',
                        ...
                        requiresRestart: true,
                        default: true,
                        description: 'Let the search agent open and read result pages (DashScope web_extractor) for better-grounded answers. Billed separately by DashScope. Env override: WEB_SEARCH_EXTRACTOR.',
                        showInDialog: true,
                    },
                },
            },
            toolSearch: {
                ...
                properties: {
                    ...
                    threshold: {
                        ...
                        requiresRestart: true,
                        default: 10,
                        description: 'Context-window percentage used as the session-start budget for preloading deferred tools (bundled built-ins and MCP alike). When every deferred tool schema fits within the budget, all are declared upfront instead of loaded on demand, keeping the prompt prefix stable for KV caching. Set 0 to always load deferred tools on demand.',
                        showInDialog: true,
            ...
            listDirectory: {
                ...
                requiresRestart: true,
                default: {},
                description: 'Settings for the built-in list_directory tool. Opt-in: the tool is disabled by default because glob covers directory listing in most cases.',
                showInDialog: false,
                properties: {
                    enabled: {
                        type: 'boolean',
                        ...
                        requiresRestart: true,
                        default: false,
                        description: 'Enable the built-in list_directory tool. Disabled by default; it is also re-enabled automatically when explicitly listed in the coreTools allowlist (--core-tools / tools.core).',
                        showInDialog: true,
                    },
                },
            },
            shell: {
                ...
                properties: {
                    ...
                    defaultTimeoutMs: {
                        ...
                        requiresRestart: true,
                        default: undefined,
                        description: 'Default timeout, in milliseconds, for foreground shell commands started by the agent. A per-call timeout on the shell tool overrides this. When unset, foreground commands time out after 120000 ms (2 minutes). Set to 0 to disable the timeout.',
                        showInDialog: false,
                    },
                    heartbeatIntervalMs: {
                        type: 'integer',
            ...
            toolOutputBatchBudget: {
                ...
                description: 'Per-message character budget for the combined text output of one batch of tool calls. Oversized batches are reduced deterministically and recoverable output is persisted when possible. Set to -1 to disable.',
                showInDialog: false,
            },
            computerUse: {
                type: 'object',
                ...
                requiresRestart: true,
                default: {},
                description: "Cross-platform desktop automation via the cua-driver native driver (trycua/cua). On first invocation a pinned, signed + notarized binary (~20MB) is downloaded into ~/.lailatulcoder/computer-use/ and the user is walked through macOS Accessibility / Screen Recording permissions if needed. Exposes cua-driver's full tool surface (click, type_text, scroll, drag, press_key, get_window_state, page, launch_app, and more).",
                showInDialog: false,
                properties: {
                    enabled: {
                        type: 'boolean',
                    ...
                    idleTimeoutMs: {
                        ...
                        minimum: 0,
                        maximum: 2147483647,
                        description: 'Milliseconds to keep the cua-driver process alive after the last computer_use__* call. The default is 300000 (5 minutes). Set to 0 to keep it running until lailatul-coder exits.',
                        showInDialog: false,
                    },
                    maxImageDimension: {
                        type: 'number',
    ...
    policy: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Daemon multi-client coordination policies. Tool-level allow/deny rules ' +
            'live under `permissions`; this section is for runtime mediation behavior ' +
            'between concurrent HTTP clients sharing one `LailatulCoder serve` daemon.',
        showInDialog: false,
        properties: {
            permissionStrategy: {
                type: 'enum',
                ...
                description: 'How permission requests resolve when multiple clients are attached. ' +
                    ...
                    'NOTE: client identity comes from self-declared X-LailatulCoder-Client-Id ' +
            ...
            consensusQuorum: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Optional fixed quorum size for consensus policy. Capped at M ' +
                    '(count of registered voters at request issue time) to prevent ' +
                    'unreachable quorum. Unset = floor(M/2)+1. ' +
                    'Requires daemon restart — read once at boot.',
                showInDialog: false,
                // run-LailatulCoder-serve.ts validates `Number.isInteger(n) && n >= 1` and
    ...
    advanced: {
        ...
        properties: {
            ...
            runtimeOutputDir: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Custom directory for runtime output (temp files, debug logs, session data, todos, etc.). ' +
                    'Config files remain at ~/.lailatulcoder (or QWEN_HOME if set). Env var QWEN_RUNTIME_DIR takes priority.',
                showInDialog: false,
            },
        },
    },
    agents: {
        ...
        properties: {
            ...
            modelGrades: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Maps semantic model grade names exposed to the Agent tool to concrete model selectors.',
                showInDialog: false,
                mergeStrategy: MergeStrategy.SHALLOW_MERGE,
                jsonSchemaOverride: {
                    type: 'object',
            ...
            allowedGrades: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Optional whitelist of model grade names the Agent tool may use.',
                showInDialog: false,
                items: { type: 'string' },
            },
            maxParallelAgents: {
            ...
            arena: {
                ...
                properties: {
                    worktreeBaseDir: {
                        ...
                        requiresRestart: true,
                        default: undefined,
                        description: 'Custom base directory for Arena worktrees. Defaults to ~/.lailatulcoder/arena.',
                        showInDialog: false,
                    },
                    preserveArtifacts: {
                        type: 'boolean',
    ...
    stopHookBlockingCap: {
        ...
        description: 'Maximum consecutive blocking Stop/SubagentStop hook decisions before LailatulCoder Ai overrides the hook loop and ends the turn. Can be overridden by QWEN_CODE_STOP_HOOK_BLOCK_CAP.',
    ...
    hooks: {
        ...
        properties: {
            ...
            StopFailure: {
                ...
                requiresRestart: false,
                default: [],
                description: 'Hooks that execute when a turn ends due to an API error or loop detection, instead of the normal Stop hooks. Receives error type and details.',
                showInDialog: false,
                mergeStrategy: MergeStrategy.CONCAT,
                items: HOOK_DEFINITION_ITEMS,
            },
            MessageDisplay: {
                ...
                requiresRestart: false,
                default: [],
                description: 'Hooks that execute repeatedly as the assistant reply streams, before the After Agent (Stop) hooks fire.',
                showInDialog: false,
                mergeStrategy: MergeStrategy.CONCAT,
                items: HOOK_DEFINITION_ITEMS,
            },
    ...
    experimental: {
        ...
        properties: {
            liveVoice: {
                ...
                requiresRestart: false,
                default: {},
                description: 'Experimental realtime voice conversations through LailatulCoder Live Host on macOS WebShell.',
                showInDialog: false,
                properties: {
                    enabled: {
                        type: 'boolean',
                        ...
                        requiresRestart: false,
                        default: false,
                        description: 'Enable experimental realtime voice conversations on macOS WebShell.',
                        showInDialog: false,
                    },
                    apiKey: {
                        type: 'string',
                        ...
                        requiresRestart: false,
                        default: '',
                        description: 'Dedicated DashScope API key for qwen3.5-omni-plus-realtime.',
                        showInDialog: false,
                    },
                    model: {
                        type: 'string',
                    ...
                    endpoint: {
                        ...
                        description: 'Advanced override for the DashScope Realtime WebSocket endpoint.',
                        showInDialog: false,
                    },
                    voice: {
                        type: 'string',
                    ...
                    shortcut: {
                        ...
                        requiresRestart: false,
                        default: 'Command+E',
                        description: 'Electron accelerator registered globally by LailatulCoder Live Host.',
                        showInDialog: false,
                    },
                },
            },
            ...
            sessionWriterLease: {
                ...
                requiresRestart: true,
                default: false,
                description: 'Enable cross-process write fencing for persisted ACP and daemon sessions. The effective value is frozen when the ACP or daemon process starts. Every concurrent ACP or daemon writer must enable the setting; interactive and headless writers remain outside the protocol.',
                showInDialog: true,
            },
    ...
    worktree: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Configuration for general-purpose git worktrees created by the ' +
        ...
        properties: {
            symlinkDirectories: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Directories under the main repository to symlink into every ' +
                    ...
                    '`.lailatulcoder` (the CLI-managed metadata tree, which contains ' +
