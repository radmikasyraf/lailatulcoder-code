 ...
 */
export function visualClickToOffset(buffer, absoluteVisualRow, clickVisualCol) {
    ...
    return logicalPosToOffset(buffer.lines, logicalLineIndex, Math.min(logicalCol, lineLength));
}
//# sourceMappingURL=input-mouse.js.map