...
describe('ToolCallPreparationTracker', () => {
    ...
    it('discards a resolved preparation when the stream attempt is abandoned', async () => {
        ...
        expect(emitPreparationDiscarded).toHaveBeenCalledWith('call-1', 'read_file');
    });
...
//# sourceMappingURL=tool-call-preparation-tracker.test.js.map