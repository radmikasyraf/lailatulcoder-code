...
import type { DeviceFlowProviderId, DeviceFlowRegistry } from '../auth/device-flow.js';
import type { DaemonLogger } from '../daemon-logger.js';
import { type DaemonMetricsBucket, type DaemonPerfSnapshot, type DaemonStartupSnapshot } from '../daemon-status.js';
...
interface RegisterDaemonStatusRoutesDeps {
    ...
    currentServeFeatures: () => ReturnType<typeof import('../capabilities.js').getAdvertisedServeFeatures>;
...
export declare function registerDaemonStatusRoutes(app: Application, deps: RegisterDaemonStatusRoutesDeps): void;
export {};
