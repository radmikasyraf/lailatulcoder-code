...
export declare class RecordArtifactTool extends BaseDeclarativeTool<RecordArtifactParams, ToolResult> {
    ...
    validateToolParams(params: RecordArtifactParams): string | null;
...
export declare function hasControlCharacter(value: string, allowLineWhitespace?: boolean): boolean;
export declare function hasUnsafeDisplayPayload(value: string): boolean;
export declare function isRecordableDerivedChild(title: string, workspacePath: string): boolean;
