 ...
 */
export type CacheRetentionByBlock = Partial<Record<'system' | 'tool' | 'user.last', CacheRetention>>;
export interface ConvertGeminiRequestToAnthropicOptions {
     ...
     * stray thinking blocks. https://github.com/LailatulCoder/lailatul-coder/issues/3786
     */
...
export declare class AnthropicContentConverter {
    ...
    constructor(_model: string, schemaCompliance?: SchemaComplianceMode, enableCacheControl?: boolean);
