...
import { SubagentManager, type SubagentConfig } from '@lailatul-coder/lailatul-coder-core';
import { InvalidClientIdError, type AcpSessionBridge } from './acp-session-bridge.js';
import type { WorkspaceRegistry } from './workspace-registry.js';
import { type ServeWorkspaceAgentDetail, type ServeWorkspaceAgentSummary } from '@lailatul-coder/acp-bridge/status';
/**
