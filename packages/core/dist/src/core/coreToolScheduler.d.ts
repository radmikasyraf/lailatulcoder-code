...
export declare function convertToFunctionErrorResponse(toolName: string, callId: string, llmContent: PartListUnion, fallbackError: string): Part[];
 ...
 * runs sequentially).
 */
export declare function isToolCallConcurrencySafe(name: string, kind: Kind | undefined, args: unknown): boolean;
/**
 ...
 */
export declare function partitionByConcurrencySafety<T>(items: T[], isSafe: (item: T) => boolean): Array<ConcurrencyBatch<T>>;
export declare class CoreToolScheduler {
    ...
    schedule(request: ToolCallRequestInfo | ToolCallRequestInfo[], signal: AbortSignal, runtimeView?: RuntimeContentGeneratorView): Promise<void>;
