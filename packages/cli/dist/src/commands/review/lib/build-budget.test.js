...
import { BUILD_TEST_BUDGET_HEADROOM_S, SHELL_TOOL_MAX_TIMEOUT_MS, DEFAULT_COMMAND_TIMEOUT_S, DEFAULT_WHOLE_CALL_BUDGET_S, MAX_RESUME_CALLS, } from './build-budget.js';
describe('build-test budget constants', () => {
    it('keeps the whole-call budget inside the shell tool the brief welds on', () => {
        ...
        expect(DEFAULT_WHOLE_CALL_BUDGET_S + BUILD_TEST_BUDGET_HEADROOM_S).toBe(SHELL_TOOL_MAX_TIMEOUT_MS / 1000);
    });
...
//# sourceMappingURL=build-budget.test.js.map