 ...
 */
import { IdeClient, logIdeConnection, IdeConnectionEvent, IdeConnectionType, } from '@lailatul-coder/lailatul-coder-core';
import { QWEN_CODE_COMPANION_EXTENSION_NAME, getIdeInstaller, IDEConnectionStatus, ideContextStore, } from '@lailatul-coder/lailatul-coder-core';
    ...
    if (!currentIDE) {
        return {
            ...
            action: () => ({
                type: 'message',
                messageType: 'error',
                content: t('IDE integration is not supported in your current environment. To use this feature, run LailatulCoder Ai in one of these supported IDEs: VS Code or VS Code forks.'),
            }),
        };
    }
