 ...
 * `LailatulCoder --acp` child reports `channel=daemon` instead of the generic `ACP`.
 * The Tauri desktop shell launches `LailatulCoder serve` with `QWEN_CODE_DESKTOP=1`
 ...
 *
 * A `LailatulCoder --acp` child cannot otherwise tell it was daemon-spawned: direct
...
export function resolveAcpChannelFallback(env = process.env) {
...
//# sourceMappingURL=acp-channel-fallback.js.map