...
import { getAvailableModelsForAuthType, getFilteredQwenModels, getOpenAIAvailableModelFromEnv, } from './availableModels.js';
...
describe('availableModels', () => {
    ...
    describe('getAvailableModelsForAuthType', () => {
        ...
        it('should use config models for qwen-oauth when config is provided', () => {
            ...
            const models = getAvailableModelsForAuthType(AuthType.QWEN_OAUTH, mockConfig);
        ...
        it('should use config.getAvailableModels for openai authType when available', () => {
            ...
            const models = getAvailableModelsForAuthType(AuthType.USE_OPENAI, mockConfigWithMethod);
        ...
        it('should fallback to env var for openai when config returns empty', () => {
            ...
            const models = getAvailableModelsForAuthType(AuthType.USE_OPENAI, mockConfig);
            expect(models).toEqual([]);
        });
...
//# sourceMappingURL=availableModels.test.js.map