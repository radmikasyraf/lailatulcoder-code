 ...
 */
export function detectWorkflowKeyword(text) {
    return text
        .toLowerCase()
        .split(/\s+/)
...
export function buildWorkflowSteeringNotice() {
    return ('The user\'s message includes the "workflow" keyword. If this request ' +
...
//# sourceMappingURL=workflow-keyword.js.map