...
import { IdeClient, IDEConnectionStatus, ideContextStore, } from '@lailatul-coder/lailatul-coder-core';
...
export function useIdeTrustListener() {
    ...
    const [connectionStatus, setConnectionStatus] = useState(IDEConnectionStatus.Disconnected);
