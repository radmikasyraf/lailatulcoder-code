...
import { HookEventName, HookType, HooksConfigSource, } from '@lailatul-coder/lailatul-coder-core';
...
describe('HooksListStep', () => {
    const createMockHookInfo = (event, configCount = 0) => {
    ...
    it('should render empty state when no hooks', () => {
        const { lastFrame } = render(_jsx(HooksListStep, { hooks: [], selectedIndex: 0 }));
    ...
    it('should render list of hooks', () => {
        ...
        const { lastFrame } = render(_jsx(HooksListStep, { hooks: hooks, selectedIndex: 0 }));
...
//# sourceMappingURL=HooksListStep.test.js.map