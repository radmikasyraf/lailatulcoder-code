 ...
 */
export declare function tildeifyPath(filePath: string, homeOverride?: string): string;
/**
 ...
 */
export declare function realpathNearestExistingAsync(inputPath: string): Promise<string>;
/**
