...
export const UpdatePreferencesSchema = z.object({
  ...
  includeCoAuthoredBy: z.boolean().optional().describe("Whether to include 'Co-Authored-By: LailatulCoder Ai' trailer on git commits. Defaults to true."),
});
...
export const SpawnSessionSchema = z.object({
  ...
  llmConnection: z.string().optional().describe('Connection slug (e.g., "lailatul-coder")'),
...
- Do NOT include any text or tool calls after SubmitPlan - they will not be executed`,
  ...
  config_validate: `Validate LailatulCoder Ai configuration files.
...
Only use 'attachments' for existing file paths on disk — the tool reads them automatically.`,
  ...
  send_developer_feedback: `Send freeform feedback to the LailatulCoder Ai development team.
