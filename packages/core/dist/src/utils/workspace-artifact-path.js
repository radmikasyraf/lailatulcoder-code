...
const WORKTREE_DIR_RE = /^(.*)[\\/]\.lailatulcoder[\\/]worktrees[\\/][^\\/]+$/;
/**
 * Session cwd may be a worktree (`<root>/.lailatulcoder/worktrees/<slug>`). Artifact
 ...
 */
export function resolveBoundWorkspaceRoot(targetDir) {
    ...
    // `C:\.lailatulcoder\worktrees\x` captures `C:`, which is drive-relative, not `C:\`.
    if (/^[A-Za-z]:$/.test(base)) {
 ...
 */
export function toCanonicalWorkspaceArtifactPath(absoluteFilePath, targetDir) {
...
//# sourceMappingURL=workspace-artifact-path.js.map