 ...
 */
import { AcpPreAttachBudget, type AcpPreAttachLease } from './pre-attach-budget.js';
...
export declare class AcpConnection {
    ...
    private readonly preAttachBudget;
    private readonly onFatalConnection?;
    private readonly maxFramesPerConnection;
    private readonly maxPayloadBytesPerConnection;
    private readonly onPreAttachGuardFailure?;
    ...
    private nextPreparedSequence;
    private ownedFrames;
    private ownedBytes;
    private connOwnedFrames;
    private readonly pendingReceipts;
    private readonly sessionOwnershipStates;
    ...
    lastActiveMs: number;
    private idCounter;
    constructor(connectionId: string | undefined, fromLoopback: boolean, onAbandonPending?: AbandonPendingFn | undefined, onDetachSession?: DetachSessionFn | undefined, preAttachBudget?: AcpPreAttachBudget, onFatalConnection?: ((connection: AcpConnection, reason: TransportCloseReason) => void) | undefined, maxFramesPerConnection?: number, maxPayloadBytesPerConnection?: number, onPreAttachGuardFailure?: (() => void) | undefined);
    /**
    ...
    canCommitSessionOwnership(sessionId: string, ownership: SessionOwnershipIdentity): boolean;
    releaseSessionOwnershipIdentity(sessionId: string, ownership: SessionOwnershipIdentity): void;
     ...
     */
    sendSession(sessionId: string, frame: unknown, id?: number): Promise<DeliveryResult>;
    /**
     ...
     * non-resumed stream).
     */
    sendSessionReply(sessionId: string, frame: unknown, anchorId?: number): Promise<DeliveryResult>;
    /**
    ...
    private discardPreparedReceipt;
    private invokeReceipt;
    private failOwner;
    private failSerializationOwner;
...
export declare class ConnectionRegistry {
    ...
    private preAttachGuardFailures;
    constructor(onAbandonPending?: AbandonPendingFn | undefined, onDetachSession?: DetachSessionFn | undefined, maxConnections?: number, idleTtlMs?: number, preAttachBudget?: AcpPreAttachBudget, maxFramesPerConnection?: number, maxPayloadBytesPerConnection?: number);
    /**
