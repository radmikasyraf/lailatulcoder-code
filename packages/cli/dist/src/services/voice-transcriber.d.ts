...
export type VoiceStreamingTransport = 'qwen-asr-realtime' | 'dashscope-task-realtime';
...
export declare function assertVoiceBaseUrlNetworkAllowed(voiceConfig: VoiceTranscriptionConfig, lookupHost?: VoiceHostLookup, abortSignal?: AbortSignal): Promise<void>;
export declare function resolveVoiceTranscriptionConfig({ config, settings, voiceModel, env, }: ResolveVoiceTranscriptionConfigArgs): VoiceTranscriptionConfig;
...
export declare function resolveVoiceStreamConfig(args: ResolveVoiceTranscriptionConfigArgs): ResolvedVoiceStreamConfig;
/**
 ...
 */
export declare function isKeytermEcho(transcript: string, keytermsContext?: string): boolean;
export declare const MAX_AUDIO_BYTES: number;
export declare function sanitizeVoiceErrorMessage(raw: string, apiKey?: string): string;
export declare function transcribeVoiceAudio(audio: RecordedVoiceAudio, args: TranscribeVoiceAudioArgs): Promise<string>;
