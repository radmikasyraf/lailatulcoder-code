...
export declare function collectContextData(config: import('@lailatul-coder/lailatul-coder-core').Config, showDetails: boolean): Promise<HistoryItemContextUsage>;
/**
