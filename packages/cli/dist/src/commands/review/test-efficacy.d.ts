 ...
 * is new ground.
 */
export declare function committedSymlinkProbes(tree: string, probes: string[]): Set<string>;
 ...
 * to remove.
 */
export declare function runOneHunkProbe(probeTree: string, hunk: HunkCandidate, probes: string[], deadlineAt?: number, now?: () => number, dependencyRoot?: string): HunkResult;
/**
 ...
 */
export declare function runControlMutant(probeTree: string, probeFile: string, deadlineAt?: number, now?: () => number, dependencyRoot?: string): boolean | null;
