 ...
 */
import { type AgentCore, type AgentInteractive } from '@lailatul-coder/lailatul-coder-core';
...
export declare const AgentChatContent: ({ core, interactiveAgent, instanceKey, modelName, }: AgentChatContentProps) => import("react").JSX.Element;
