...
export const TOKEN_PLAN_CHINA_BASE_URL = 'https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1';
export const TOKEN_PLAN_GLOBAL_BASE_URL = 'https://token-plan.ap-southeast-1.maas.aliyuncs.com/compatible-mode/v1';
...
// Provider config
// ---------------------------------------------------------------------------
export const tokenPlanProvider = {
    id: 'token-plan',
    label: 'Token Plan',
    ...
    modelsEditable: true,
    modelNamePrefix: (baseUrl) => baseUrl === TOKEN_PLAN_GLOBAL_BASE_URL
        ? 'ModelStudio Token Plan for Global/Intl'
        : 'ModelStudio Token Plan',
    ownsModel: (model) => model.envKey === TOKEN_PLAN_ENV_KEY &&
...
//# sourceMappingURL=alibaba-token-plan.js.map