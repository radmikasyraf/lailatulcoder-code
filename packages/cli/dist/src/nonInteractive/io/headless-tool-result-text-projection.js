...
export function projectHeadlessToolResultContent(value) {
    return projectJsonStringToByteBudget(value, HEADLESS_TOOL_RESULT_TEXT_JSON_BYTE_BUDGET, HEADLESS_TOOL_RESULT_TEXT_TRUNCATION_MARKER);
}
//# sourceMappingURL=headless-tool-result-text-projection.js.map