 ...
 */
export type CodeChangeProbe = (path: string, sinceSha: string | undefined) => {
 ...
 * of the same data.
 */
export declare function buildThreadStatuses(comments: RawStatusComment[], prAuthor: string, probe: CodeChangeProbe, me?: string): ThreadStatus[];
...
export declare function summarizeThreads(threads: ThreadStatus[]): ThreadSummary;
/**
