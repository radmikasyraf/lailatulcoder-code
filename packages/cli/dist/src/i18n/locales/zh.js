...
export default {
  ...
  'How is LailatulCoder doing this session? (optional)': 'LailatulCoder 这次表现如何？（可选）',
  Bad: '不满意',
  Fine: '还行',
  Good: '满意',
  Dismiss: '忽略',
  ...
  'This extension will append info to your LAILATUL.md context using {{fileName}}':
    '此扩展将使用 {{fileName}} 向您的 LAILATUL.md 上下文追加信息',
  ...
  'stdout shown to LailatulCoder': '向 LailatulCoder 显示 stdout',
  ...
  'Run LailatulCoder --debug to see error logs': '运行 LailatulCoder --debug 查看错误日志',
  ...
  'Successfully added LAILATUL.md files from the following directories if there are:\n- {{directories}}':
    '如果存在，已成功从以下目录添加 LAILATUL.md 文件：\n- {{directories}}',
  ...
  'LailatulCoder Auth': 'LailatulCoder Auth (免费)',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'LailatulCoder Auth 免费额度已于 2026-04-15 停用。请选择 Coding Plan 或 API Key。',
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'LailatulCoder OAuth免费层已于2026-04-15停止服务。请选择其他提供商的模型或运行 /auth 切换。',
  '\n⚠ LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ LailatulCoder Auth 免费额度已于 2026-04-15 停用。请选择其他选项。\n',
  ...
  'LailatulCoder Auth Authentication': 'LailatulCoder Auth 认证',
  'Please visit this URL to authorize:': '请访问此 URL 进行授权：',
  'Waiting for authorization': '等待授权中',
  'Time remaining:': '剩余时间：',
  'LailatulCoder Auth Authentication Timeout': 'LailatulCoder Auth 认证超时',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth token 已过期（超过 {{seconds}} 秒）。请重新选择认证方法',
  'Press any key to return to authentication type selection.':
    '按任意键返回认证类型选择',
  'Waiting for LailatulCoder Auth authentication...': '正在等待 LailatulCoder Auth 认证...',
  ...
  'You can resume a previous conversation by running lailatulcoder --continue or lailatulcoder --resume.':
    '运行 lailatulcoder --continue 或 lailatulcoder --resume 可继续之前的会话。',
  ...
  'Add a LAILATUL.md file to give LailatulCoder Ai persistent project context.':
    '添加 LAILATUL.md 文件，为 LailatulCoder Ai 提供持久的项目上下文。',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: 导航 | Enter: 选择 | Esc: 取消',
  'Authenticate using LailatulCoder Auth': '使用 LailatulCoder Auth 进行认证',
  ...
  'Starting LailatulCoder Auth authentication...': '正在启动 LailatulCoder Auth 认证...',
  'Successfully authenticated with LailatulCoder Auth.': '已成功通过 LailatulCoder Auth 认证。',
  'Failed to authenticate with LailatulCoder Auth: {{error}}':
    'LailatulCoder Auth 认证失败：{{error}}',
  ...
  '  LailatulCoder auth LailatulCoder-oauth     - Authenticate with LailatulCoder Auth (discontinued)':
    '  LailatulCoder auth LailatulCoder-oauth     - 使用 LailatulCoder Auth 登录（已停用）',
  'Or simply run:': '或者直接运行：',
  '  LailatulCoder auth                - Interactive authentication setup\n':
    '  LailatulCoder auth                - 交互式认证配置\n',
  '✓ Authentication Method: LailatulCoder Auth': '✓ 认证方式：Qwen OAuth',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'LailatulCoder Auth 免费额度已于 2026-04-15 停用。请运行 /auth 切换到 Coding Plan、OpenRouter、Fireworks AI 或其他服务商。',
  ...
  '  Run `LailatulCoder auth coding-plan` to re-configure.\n':
    '  运行 `LailatulCoder auth coding-plan` 重新配置。\n',
