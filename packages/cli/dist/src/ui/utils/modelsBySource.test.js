...
const coreWithRequests = (requests) => ({
    ...emptyCore(),
    api: { totalRequests: requests, totalErrors: 0, totalLatencyMs: 0 },
});
const makeModel = (bySource) => {
    const totalRequests = Object.values(bySource).reduce((sum, m) => sum + m.api.totalRequests, 0);
    return {
        ...emptyCore(),
...
//# sourceMappingURL=modelsBySource.test.js.map