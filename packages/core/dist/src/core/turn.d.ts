...
import type { ToolCallConfirmationDetails, ToolArtifact, ToolResultBoundaryArtifact, ToolResult, ToolResultDisplay } from '../tools/tools.js';
 ...
 */
export declare function findRepeatedDuplicateProviderToolCall<T>(items: readonly T[], getProviderCallId: (item: T) => string | undefined, isReplayOfHandled: (item: T) => boolean, duplicateProviderToolCallResponseIds: ReadonlySet<string>): T | undefined;
