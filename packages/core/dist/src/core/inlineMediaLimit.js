 ...
 */
export function getMaxInlineMediaBytes() {
 ...
 */
export function oversizedMediaPlaceholder(mimeType, bytes, limitBytes) {
    ...
    return (`[Media omitted: ${mime} is ~${formatMb(bytes)}MB, exceeding the ` +
 ...
 */
export function clampInlineMediaPart(part, limitBytes = getMaxInlineMediaBytes()) {
...
//# sourceMappingURL=inlineMediaLimit.js.map