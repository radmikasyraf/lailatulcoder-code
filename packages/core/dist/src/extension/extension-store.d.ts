 ...
 */
import { type AllExtensionsEnablementConfig } from './override.js';
...
export declare class ExtensionStore {
    ...
    setDefaultActivations(identities: readonly ExtensionIdentity[], activation: ExtensionActivation): Promise<ExtensionStoreSnapshot>;
    ...
    setWorkspaceActivations(identities: readonly ExtensionIdentity[], workspacePath: string, activation: ExtensionActivation): Promise<ExtensionStoreSnapshot>;
    clearWorkspaceActivation(identity: ExtensionIdentity, workspacePath: string): Promise<ExtensionStoreSnapshot>;
    clearWorkspaceActivations(identities: readonly ExtensionIdentity[], workspacePath: string): Promise<ExtensionStoreBatchMutationOutcome>;
    ...
    private mutate;
    private mutateMany;
    private extensionArtifactExists;
    ...
    private assertArtifactDestination;
    private pathExists;
