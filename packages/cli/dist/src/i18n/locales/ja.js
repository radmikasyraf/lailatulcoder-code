...
export default {
  ...
  'Analyzes the project and creates a tailored LAILATUL.md file.':
    'プロジェクトを分析し、カスタマイズされた LAILATUL.md ファイルを作成',
  ...
  'To add hooks, edit settings.json directly or ask LailatulCoder.':
    'フックを追加するには、settings.json を直接編集するか、LailatulCoder に尋ねてください。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask LailatulCoder to help.':
    'このフックを変更または削除するには、settings.json を直接編集するか、LailatulCoder に尋ねてください。',
  // Hooks - Disabled Step
  ...
  'stdout shown to LailatulCoder': 'stdout を LailatulCoder に表示',
  ...
  'Successfully added LAILATUL.md files from the following directories if there are:\n- {{directories}}':
    '以下のディレクトリから LAILATUL.md ファイルを追加しました(存在する場合):\n- {{directories}}',
  ...
  'Run LailatulCoder --debug to see error logs':
    'LailatulCoder --debug を実行してエラーログを確認してください',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'LailatulCoder Auth 無料枠は 2026-04-15 に終了しました。Coding Plan または API Key を選択してください。',
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'LailatulCoder OAuth無料プランは2026-04-15に終了しました。他のプロバイダーのモデルを選択するか、/authを実行して切り替えてください。',
  '\n⚠ LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ LailatulCoder Auth 無料枠は 2026-04-15 に終了しました。他のオプションを選択してください。\n',
  ...
  'LailatulCoder Auth Authentication': 'LailatulCoder OAuth認証',
  'Please visit this URL to authorize:':
    '認証するには以下のURLにアクセスしてください:',
  'Waiting for authorization': '認証を待っています',
  'Time remaining:': '残り時間:',
  'LailatulCoder Auth Authentication Timeout': 'LailatulCoder OAuth認証タイムアウト',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuthトークンが期限切れです({{seconds}}秒以上)。認証方法を再度選択してください',
  'Press any key to return to authentication type selection.':
    '認証タイプ選択に戻るには任意のキーを押してください',
  'Waiting for LailatulCoder Auth authentication...': 'LailatulCoder OAuth認証を待っています...',
  ...
  'You can resume a previous conversation by running lailatulcoder --continue or lailatulcoder --resume.':
    'lailatulcoder --continue または lailatulcoder --resume で前の会話を再開できます。',
  ...
  'Add a LAILATUL.md file to give LailatulCoder Ai persistent project context.':
    'LAILATUL.md ファイルを追加すると、LailatulCoder Ai に永続的なプロジェクトコンテキストを与えられます。',
  ...
  'Authenticate using LailatulCoder Auth': 'LailatulCoder Auth で認証する',
  ...
  'Starting LailatulCoder Auth authentication...': 'LailatulCoder Auth 認証を開始しています...',
  'Successfully authenticated with LailatulCoder Auth.':
    'LailatulCoder Auth での認証に成功しました。',
  'Failed to authenticate with LailatulCoder Auth: {{error}}':
    'LailatulCoder Auth での認証に失敗しました: {{error}}',
  ...
  '  LailatulCoder auth LailatulCoder-oauth     - Authenticate with LailatulCoder Auth (discontinued)':
    '  LailatulCoder auth LailatulCoder-oauth     - LailatulCoder Auth で認証（終了）',
  'Or simply run:': 'または以下を実行:',
  '  LailatulCoder auth                - Interactive authentication setup\n':
    '  LailatulCoder auth                - インタラクティブ認証セットアップ\n',
  '✓ Authentication Method: LailatulCoder Auth': '✓ 認証方法: LailatulCoder Auth',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'LailatulCoder Auth 無料枠は 2026-04-15 に終了しました。/auth を実行して Coding Plan、OpenRouter、Fireworks AI、または他のプロバイダーに切り替えてください。',
  ...
  '  Run `LailatulCoder auth coding-plan` to re-configure.\n':
    '  `LailatulCoder auth coding-plan` を実行して再設定してください。\n',
  ...
  'How is LailatulCoder doing this session? (optional)':
    'このセッションでの LailatulCoder の調子はどうですか？（任意）',
  ...
  'This extension will append info to your LAILATUL.md context using {{fileName}}':
    'この拡張機能は {{fileName}} を使って LAILATUL.md コンテキストに情報を追記します',
