...
export type ConversationBranchClassification = 'ordinary' | 'rewind-descendant' | 'rewind-sibling' | 'mixed-rewind';
...
export declare function inspectConversationBranches(records: readonly ChatRecord[]): ConversationBranchAnalysis;
