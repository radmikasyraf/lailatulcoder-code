...
export function runWithAgentContext(agentId, fn, depthOverride) {
 ...
 */
export function getCurrentAgentDepth() {
 ...
 * with this helper.
 */
export function runOutsideAgentContext(fn) {
 ...
 */
export function childLaunchDepth() {
 ...
 */
export function canSpawnNestedAgent(maxDepth) {
 ...
 */
export function spawnBlockReason(maxDepth) {
    if (!canSpawnNestedAgent(maxDepth))
        return 'depth';
    if (isTeammate())
        return 'teammate';
