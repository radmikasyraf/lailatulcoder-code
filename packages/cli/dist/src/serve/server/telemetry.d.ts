...
export declare const legacySessionTelemetryRoutes: readonly [{
    ...
    readonly method: "POST";
    readonly path: "/session/:id/goal";
    readonly attribution: "handler_resolved";
    readonly route: "POST /session/:id/goal";
}, {
    readonly method: "GET";
    readonly path: "/session/:id/goal";
    readonly attribution: "handler_resolved";
    readonly route: "GET /session/:id/goal";
}, {
    readonly method: "POST";
    ...
    readonly method: "POST";
    readonly path: "/session/:id/attachments";
    readonly attribution: "handler_resolved";
    readonly route: "POST /session/:id/attachments";
}, {
    readonly method: "GET";
    readonly path: "/session/:id/attachments/:attachmentId";
    readonly attribution: "handler_resolved";
    readonly route: "GET /session/:id/attachments/:attachmentId";
}, {
    readonly method: "DELETE";
    readonly path: "/session/:id/attachments/:attachmentId";
    readonly attribution: "handler_resolved";
    readonly route: "DELETE /session/:id/attachments/:attachmentId";
}, {
    readonly method: "POST";
    ...
    readonly method: "GET";
    readonly path: "/session/:id/turns/current";
    readonly attribution: "handler_resolved";
    readonly route: "GET /session/:id/turns/current";
}, {
    readonly method: "GET";
    readonly path: "/session/:id/turns/:promptId";
    readonly attribution: "handler_resolved";
    readonly route: "GET /session/:id/turns/:promptId";
}, {
    readonly method: "POST";
...
export declare function setDaemonTelemetryWorkspace(res: Response, workspaceCwd: string): void;
export declare function resolveDaemonTelemetryRoute(req: Request): ResolvedDaemonTelemetryRoute | undefined;
/**
 ...
 */
export declare function daemonInboundTraceIdCaptureMiddleware(req: Request, res: Response, next: NextFunction): void;
export declare function daemonTelemetryMiddleware(resolveWorkspaceCwd: (req: Request) => string | undefined, recordRequest?: (durationMs: number, statusCode: number) => void): (req: Request, res: Response, next: NextFunction) => void;
