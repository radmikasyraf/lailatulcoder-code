...
#### 1、Clone LailatulCoder Ai project first, https://github.com/LailatulCoder/lailatul-coder.git
...
# 2. Build the LailatulCoder Ai project
npm run build
...
ls -la $(dirname $(which qwen))/../lib/node_modules/@lailatul-coder/lailatul-coder
...
- Official mirror image address:https://github.com/LailatulCoder/lailatul-coder/pkgs/container/lailatul-coder

```bash
# Based on the official Qwen sandbox image (It is recommended to explicitly specify the version)
FROM ghcr.io/LailatulCoder/lailatul-coder:sha-570ec43
...
npm unlink -g @lailatul-coder/lailatul-coder
