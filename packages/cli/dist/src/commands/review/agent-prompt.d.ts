...
import { type WorktreeResidue } from './lib/worktree.js';
 ...
 */
export declare function buildChunkAgentPrompt(report: PlanReport, id: number, rules?: string, residue?: WorktreeResidue): string;
/**
 ...
 */
export declare function buildWholeDiffBlock(report: PlanReport, rules?: string, residue?: WorktreeResidue): string;
/**
