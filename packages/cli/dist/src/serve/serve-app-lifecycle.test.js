...
import { getServeAppLifecycle, installServeAppLifecycle, } from './serve-app-lifecycle.js';
...
describe('ServeAppLifecycle', () => {
    ...
    it('rejects unbound, already-listening, and duplicate binding', async () => {
        ...
        expect(() => closedLifecycle.bindServer(createServer())).toThrow(/before its first listen/);
    });
...
//# sourceMappingURL=serve-app-lifecycle.test.js.map