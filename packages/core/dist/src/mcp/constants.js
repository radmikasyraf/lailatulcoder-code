 ...
 */
export const MCP_OAUTH_CLIENT_NAME = 'LailatulCoder Ai MCP Client';
/**
 * OAuth client name for service account impersonation provider.
 */
export const MCP_SA_IMPERSONATION_CLIENT_NAME = 'LailatulCoder Ai (Service Account Impersonation)';
/**
