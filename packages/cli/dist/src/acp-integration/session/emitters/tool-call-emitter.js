...
import { formatVisionBridgeNoticeDisplay, isVisionBridgeNoticeDisplay, toolResultBoundaryArtifact, ToolNames, Kind, } from '@lailatul-coder/lailatul-coder-core';
import { createTranscriptToolCallResultUpdate, createTranscriptToolCallStartUpdate, } from '@lailatul-coder/acp-bridge/transcriptReplay';
...
const KIND_MAP = {
    ...
    // and session/request_permission from the `LailatulCoder --acp` child before fanning out
...
export class ToolCallEmitter extends BaseEmitter {
    ...
    async emitResult(params) {
        ...
        associateAcpToolResultArtifact(update, params.boundaryArtifact ??
            toolResultBoundaryArtifact(params.persistedOutputFiles, params.artifacts));
