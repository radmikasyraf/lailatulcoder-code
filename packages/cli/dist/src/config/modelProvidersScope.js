...
export function hasOwnModelProviders(settingsObj) {
 ...
 */
export function getModelProvidersOwnerScope(settings) {
 ...
 */
export function getPersistScopeForModelSelection(settings) {
 ...
 */
export function getWritableScopes(settings) {
 ...
 * `modelProviders`.
 */
export function getOwnKeyScope(settings, key) {
...
//# sourceMappingURL=modelProvidersScope.js.map