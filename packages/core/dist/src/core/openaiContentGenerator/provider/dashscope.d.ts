 ...
 */
export declare function selectDashScopeThinkingKnob(model: string | undefined, extraBody: Record<string, unknown> | undefined, samplingParams: Record<string, unknown> | undefined, reasoningEffort: unknown): DashScopeThinkingKnobSelection | undefined;
/**
