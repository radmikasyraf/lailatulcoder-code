 ...
 */
export const HEADLESS_YOLO_NO_SANDBOX_WARNING = 'Warning: running headless with --yolo / approval-mode=yolo and no sandbox. ' +
 ...
 */
export function getHeadlessYoloSafetyWarning(config, env = process.env) {
    ...
    if (env['SANDBOX'])
        return null;
    if (isTruthyEnv(env['QWEN_CODE_SUPPRESS_YOLO_WARNING']))
        return null;
...
//# sourceMappingURL=headlessSafetyWarnings.js.map