 ...
 */
export function formatHistoryGapNotice(_gap) {
    return t('⚠️ History gap: earlier conversation was lost before this point (storage interruption) and could not be recovered.');
}
/**
 ...
 */
export function indexGapsByChild(gaps) {
...
//# sourceMappingURL=history-gap-notice.js.map