...
export declare class WorkflowTool extends BaseDeclarativeTool<WorkflowParams, WorkflowToolResult> {
    ...
    protected createInvocation(params: WorkflowParams): ToolInvocation<WorkflowParams, WorkflowToolResult>;
}
