...
export declare const TOP_LEVEL_COMMANDS: readonly [readonly ["auth", "Configure authentication (removed)"], readonly ["channel <command>", "Manage messaging channels (Telegram, Discord, etc.)"], readonly ["extensions <command>", "Manage LailatulCoder Ai extensions."], readonly ["hooks", "Manage LailatulCoder Ai hooks (use /hooks in interactive mode)."], readonly ["mcp", "Manage MCP servers"], readonly ["review <command>", "Run a review non-interactively (`run`), plus the internal helpers used by the /review skill (PR worktree setup, context fetch, rules loading, presubmit checks, cleanup)"], readonly ["serve", "Run LailatulCoder Ai as a local HTTP daemon (Stage 1 experimental: --http-bridge)"], readonly ["sessions <command>", "Manage LailatulCoder Ai sessions"], readonly ["update", "Check for LailatulCoder Ai updates and install if available"]];
