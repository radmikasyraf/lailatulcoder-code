...
export declare function isClearedMediaPlaceholder(text: string): boolean;
/**
 ...
 */
export declare function microcompactHistory(history: Content[], lastApiCompletionTimestamp: number | null, settings: ClearContextOnIdleSettings, opts?: MicrocompactOptions): {
    history: Content[];
