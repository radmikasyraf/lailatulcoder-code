 ...
 */
import type { SessionService } from '@lailatul-coder/lailatul-coder-core';
...
export declare function SessionPreview(props: SessionPreviewProps): import("react").JSX.Element;
