...
import { Config, FileDiscoveryService, ExtensionManager, } from '@lailatul-coder/lailatul-coder-core';
...
export const reconnectCommand = {
    ...
    builder: (yargs) => yargs
        .usage('Usage: LailatulCoder mcp reconnect [options] [server-name]')
