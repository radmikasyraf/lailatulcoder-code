...
import { writeWorktreeSession, clearWorktreeSession, } from '@lailatul-coder/lailatul-coder-core';
import { useWorktreeSession } from './useWorktreeSession.js';
const SESSION_ID = 'test-session-id';
function makeMockConfig(sidecarPath) {
    return {
        getSessionId: () => SESSION_ID,
        getSessionService: () => ({
            getWorktreeSessionPath: (_id) => sidecarPath,
        }),
    };
}
const sample = {
...
//# sourceMappingURL=useWorktreeSession.test.js.map