...
declare const TOOL_CALL_COUNT = "lailatul-coder.tool.call.count";
declare const TOOL_EXECUTION_COUNT = "lailatul-coder.tool.execution.count";
export declare const REPEATED_TOOL_FAILURE_GUARD_COUNT = "lailatul-coder.repeated_tool_failure_guard.count";
declare const API_REQUEST_COUNT = "lailatul-coder.api.request.count";
declare const TOKEN_USAGE = "lailatul-coder.token.usage";
declare const FILE_OPERATION_COUNT = "lailatul-coder.file.operation.count";
declare const API_RETRY_COUNT = "lailatul-coder.api.retry.count";
export declare const SUBAGENT_EXECUTION_COUNT = "lailatul-coder.subagent.execution.count";
declare const STARTUP_TIME = "lailatul-coder.startup.duration";
declare const MEMORY_USAGE = "lailatul-coder.memory.usage";
declare const CPU_USAGE = "lailatul-coder.cpu.usage";
declare const TOOL_EXECUTION_BREAKDOWN = "lailatul-coder.tool.execution.breakdown";
declare const TOKEN_EFFICIENCY = "lailatul-coder.token.efficiency";
declare const API_REQUEST_BREAKDOWN = "lailatul-coder.api.request.breakdown";
declare const PERFORMANCE_SCORE = "lailatul-coder.performance.score";
declare const REGRESSION_DETECTION = "lailatul-coder.performance.regression";
declare const BASELINE_COMPARISON = "lailatul-coder.performance.baseline.comparison";
declare const COUNTER_DEFINITIONS: {
    readonly "lailatul-coder.tool.call.count": {
    ...
    readonly "lailatul-coder.tool.execution.count": {
    ...
    readonly "lailatul-coder.repeated_tool_failure_guard.count": {
    ...
    readonly "lailatul-coder.api.request.count": {
    ...
    readonly "lailatul-coder.token.usage": {
    ...
    readonly "lailatul-coder.slash_command.model.call_count": {
    ...
    readonly "lailatul-coder.chat_compression": {
...
declare const HISTOGRAM_DEFINITIONS: {
    readonly "lailatul-coder.tool.call.latency": {
    ...
    readonly "lailatul-coder.api.request.latency": {
...
declare const PERFORMANCE_COUNTER_DEFINITIONS: {
    readonly "lailatul-coder.performance.regression": {
...
declare const PERFORMANCE_HISTOGRAM_DEFINITIONS: {
    readonly "lailatul-coder.startup.duration": {
    ...
    readonly "lailatul-coder.memory.usage": {
    ...
    readonly "lailatul-coder.cpu.usage": {
    ...
    readonly "lailatul-coder.tool.queue.depth": {
    ...
    readonly "lailatul-coder.tool.execution.breakdown": {
    ...
    readonly "lailatul-coder.token.efficiency": {
    ...
    readonly "lailatul-coder.api.request.breakdown": {
    ...
    readonly "lailatul-coder.performance.score": {
    ...
    readonly "lailatul-coder.performance.regression.percentage_change": {
    ...
    readonly "lailatul-coder.performance.baseline.comparison": {
