 ...
 */
import { TranscriptsUnavailableError, type AgentRecord } from './transcripts.js';
...
export declare function assignedChunk(rec: AgentRecord): number | null;
/**
 ...
 */
export declare function pointedAt(prompt: string, plan: {
    chunks: Array<{
        id: number;
        startLine: number;
        endLine: number;
