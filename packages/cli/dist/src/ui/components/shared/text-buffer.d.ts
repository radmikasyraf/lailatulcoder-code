 ...
 */
import { type EditorType } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export declare function __resetWordSegmenter(): void;
...
export declare function useTextBuffer({ initialText, initialCursorOffset, viewport, stdin, setRawMode, onChange, isValidPath, shellModeActive, preferredEditor, }: UseTextBufferProps): TextBuffer;
