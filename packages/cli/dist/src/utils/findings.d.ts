...
export declare const SEVERITIES: readonly ["Critical", "Suggestion", "Nice to have"];
 ...
 */
export declare const OUTCOMES: readonly ["fixed", "skipped", "no_change_needed"];
export type Outcome = (typeof OUTCOMES)[number];
/** Where a finding came from — the tag that decides whether it was verified. */
export declare const SOURCES: readonly ["review", "build", "test", "probe", "lint"];
 ...
 */
export declare function holdCriticalsFailingOnBase(findings: readonly Finding[], sharedFailingFiles: readonly string[]): {
    findings: Finding[];
    held: Array<{
        id: string;
        file: string;
 ...
 */
export declare function holdUnwitnessedCriticals(findings: readonly Finding[]): {
    findings: Finding[];
    unwitnessed: string[];
};
/**
 ...
 */
export declare function applyOutcomes(findings: readonly Finding[], outcomes: readonly OutcomeEntry[]): Finding[];
export declare function buildReport(findings: readonly Finding[]): FindingsReport;
/**
 ...
 */
export declare function anchorRequestsFor(findings: readonly Finding[]): AnchorRequest[];
