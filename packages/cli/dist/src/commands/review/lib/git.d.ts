...
export declare const GIT_TIMEOUT_MS = 120000;
 ...
 */
export declare function gitWithInput(input: Buffer, args: string[]): string;
/**
 ...
 */
export declare function gitProbe(...args: string[]): {
    out: string | null;
    status: number | null;
};
 ...
 */
export declare function releaseWorktree(worktreePath: string): WorktreeRelease;
/**
 ...
 */
export declare function gitRaw(...args: string[]): Buffer;
/**
 ...
 */
export declare function gitRawTolerateDiff(...args: string[]): Buffer;
