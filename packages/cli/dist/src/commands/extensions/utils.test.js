...
describe('getExtensionManager', () => {
    ...
    it('should use current working directory as workspace', async () => {
        ...
        await getExtensionManager();
        expect(ExtensionManager).toHaveBeenCalledWith(expect.objectContaining({
...
describe('extensionToOutputString', () => {
    ...
    it('should include status icon when inline is false', () => {
        ...
        const result = extensionToOutputString(extension, mockExtensionManager, '/workspace', false);
    ...
    it('should exclude status icon when inline is true', () => {
        const extension = createMockExtension();
        const result = extensionToOutputString(extension, mockExtensionManager, '/workspace', true);
    ...
    it('should default inline to false', () => {
        const extension = createMockExtension();
        const resultWithoutInline = extensionToOutputString(extension, mockExtensionManager, '/workspace');
        const resultWithInlineFalse = extensionToOutputString(extension, mockExtensionManager, '/workspace', false);
    ...
    it('should include description when present', () => {
        ...
        const result = extensionToOutputString(extension, mockExtensionManager, '/workspace');
    ...
    it('should redact URL credentials in install source output', () => {
        ...
        const result = extensionToOutputString(extension, mockExtensionManager, '/workspace', true);
        expect(result).toContain('https://***REDACTED***@example.com/owner/repo.git');
