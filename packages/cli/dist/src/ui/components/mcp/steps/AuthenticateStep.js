...
import { MCPOAuthProvider, MCPOAuthTokenStorage, getErrorMessage, } from '@lailatul-coder/lailatul-coder-core';
...
export const AuthenticateStep = ({ server, onBack, isActive = true, }) => {
