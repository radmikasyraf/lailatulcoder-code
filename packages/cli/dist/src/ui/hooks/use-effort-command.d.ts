...
export declare const useEffortCommand: (loadedSettings: LoadedSettings, config: Config, addItem?: (item: HistoryItemWithoutId, baseTimestamp: number) => void) => UseEffortCommandReturn;
export {};
