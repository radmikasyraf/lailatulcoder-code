...
import { findProviderByCredentials, resolveMetadataKey, } from '@lailatul-coder/lailatul-coder-core';
...
function formatAuth(info) {
    ...
    if (info.selectedAuthType.startsWith('oauth') ||
        info.selectedAuthType === 'LailatulCoder-oauth') {
        return 'LailatulCoder Auth';
    }
