 ...
 *  (#9106). */
const asAuthenticated = (req, _res, next) => {
...
describe('Local Control routes', () => {
    ...
    it('redacts an unauthenticated enable response and prints the URL to the daemon terminal (#9106)', async () => {
        ...
        expect(writeStdoutLineSafe).toHaveBeenCalledWith(expect.stringContaining(url));
    });
});
//# sourceMappingURL=workspace-local-control.test.js.map