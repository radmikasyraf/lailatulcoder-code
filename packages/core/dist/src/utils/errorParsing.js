 ...
 */
import { isApiError, isStructuredError, QUOTA_EXHAUSTED_PREFIX, } from './quotaErrorDetection.js';
...
export function parseAndFormatApiError(error, authType) {
    if (isStructuredError(error)) {
        ...
        const message = error instanceof Error ? getErrorMessage(error) : error.message;
