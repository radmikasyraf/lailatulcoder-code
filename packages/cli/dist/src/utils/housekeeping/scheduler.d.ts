...
declare function getFirstPassDelay(config: Config, settings: LoadedSettings): Promise<number>;
...
declare function getOpenAILogsMarkerPath(qwenDir: string, logDir: string): string;
export declare function startNonInteractiveOpenAILogHousekeeping(config: Config, settings: LoadedSettings): void;
