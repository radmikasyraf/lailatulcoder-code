...
export declare function startInteractiveUI(config: Config, settings: LoadedSettings, startupWarnings: string[], workspaceRoot: string | undefined, initializationResult: InitializationResult, options?: StartInteractiveUIOptions): Promise<void>;
