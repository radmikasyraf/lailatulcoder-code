...
import { backupSettingsFile, cleanupSettingsBackup, restoreSettingsFromBackup, getNestedProperty, } from '../utils/settingsUtils.js';
export function createLoadedSettingsAdapter(settings, scope) {
    ...
    return {
        ...
        restore() {
            ...
            if (!restored) {
                ...
                console.error(`[loadedSettingsAdapter] On-disk rollback of ${settingsFile.path} failed; ` +
...
//# sourceMappingURL=loadedSettingsAdapter.js.map