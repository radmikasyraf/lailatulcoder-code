...
export declare class ChannelWorkerControlError extends Error {
    readonly code: 'channel_worker_start_failed' | 'channel_worker_stop_failed' | 'channel_worker_not_enabled' | 'channel_runtime_owner_mismatch' | 'daemon_draining';
...
export interface ChannelWorkerManager {
    ...
    setSelection(selection: ServeChannelSelection, requiredOwner?: ChannelWorkerRequiredOwner): Promise<ChannelWorkerSetResult>;
    setChannelEnabled(owner: ChannelWorkerRequiredOwner, enabled: boolean): Promise<ChannelWorkerSetResult | ChannelWorkerStopResult>;
    ...
    deliverChannelMessage(workspaceCwd: string, request: ChannelDeliveryRequest): ReturnType<ChannelWorkerGroup['deliverChannelMessage']>;
