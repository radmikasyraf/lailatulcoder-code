 ...
 */
import { BEL, wrapForMultiplexer, oscITerm2Notify, oscKittyNotify, oscGhosttyNotify, } from '../../utils/osc.js';
 ...
 */
export function buildTerminalNotification(writeRaw) {
    return {
        ...
        writeTerminalSequence(sequence) {
            return emitTerminalSequence(sequence, writeRaw);
        },
    };
}
//# sourceMappingURL=useTerminalNotification.js.map