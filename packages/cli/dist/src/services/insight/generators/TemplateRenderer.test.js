...
vi.mock('@lailatul-coder/web-templates', () => ({
    INSIGHT_JS: '',
    INSIGHT_CSS: '',
}));
...
describe('TemplateRenderer', () => {
    it('escapes `<` in report data so it cannot break out of the inline script', async () => {
        ...
        const html = await renderer.renderInsightHTML(makeInsights({ latestActiveTime: payload }));
...
//# sourceMappingURL=TemplateRenderer.test.js.map