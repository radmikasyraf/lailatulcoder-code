...
import type { FileHistoryService } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export declare function RewindSelector({ history, onRewind, onCancel, fileCheckpointingEnabled, fileHistoryService, }: RewindSelectorProps): import("react").JSX.Element;
