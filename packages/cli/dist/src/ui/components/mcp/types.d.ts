 ...
 */
import type { MCPServerConfig, MCPServerStatus } from '@lailatul-coder/lailatul-coder-core';
/**
 * MCP管理步骤定义
 */
export declare const MCP_MANAGEMENT_STEPS: {
    readonly SERVER_LIST: "server-list";
    readonly SERVER_DETAIL: "server-detail";
    readonly DISABLE_SCOPE_SELECT: "disable-scope-select";
    readonly TOOL_LIST: "tool-list";
    readonly TOOL_DETAIL: "tool-detail";
    readonly RESOURCE_LIST: "resource-list";
    readonly RESOURCE_DETAIL: "resource-detail";
