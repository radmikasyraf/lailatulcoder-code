...
export declare function serializeSnapshot(s: FileHistorySnapshot): SerializedFileHistorySnapshot;
export declare function deserializeSnapshots(arr: SerializedFileHistorySnapshot[]): FileHistorySnapshot[];
/**
...
export declare class FileHistoryService {
    ...
    constructor(sessionId: string, enabled: boolean, cwd: string, onSnapshotUpdated?: FileHistorySnapshotRecorder);
    isEnabled(): boolean;
