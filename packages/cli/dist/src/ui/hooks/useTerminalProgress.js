...
import { OSC_PREFIX, BEL, wrapForMultiplexer, detectTerminal, } from '../../utils/osc.js';
/**
 ...
 */
export function useTerminalProgress(streamingState, hasToolExecuting) {
    const { stdout } = useStdout();
    const writeProgress = useCallback((seq) => {
        stdout?.write(seq);
    }, [stdout]);
    useEffect(() => {
    ...
    // stay stuck showing progress after LailatulCoder terminates. We deliberately
...
//# sourceMappingURL=useTerminalProgress.js.map