...
describe('FileCommandLoader - Extension Commands Support', () => {
    ...
    it('should load commands from extension with config.commands path', async () => {
        const extensionDir = path.join(projectRoot, '.qwen', 'extensions', 'test-ext');
        ...
        expect(commands[0].description).toBe('[test-ext] Test command from extension');
    });
    it('should load commands from extension with multiple commands paths', async () => {
        const extensionDir = path.join(projectRoot, '.qwen', 'extensions', 'multi-ext');
        const extensionConfig = {
            name: 'multi-ext',
            version: '1.0.0',
    ...
    it('should fallback to default "commands" directory when config.commands not specified', async () => {
        const extensionDir = path.join(projectRoot, '.qwen', 'extensions', 'default-ext');
        const extensionConfig = {
            name: 'default-ext',
            version: '1.0.0',
        };
    ...
    it('should handle extension without commands directory gracefully', async () => {
        const extensionDir = path.join(projectRoot, '.qwen', 'extensions', 'no-cmds-ext');
        const extensionConfig = {
            name: 'no-cmds-ext',
            version: '1.0.0',
        };
    ...
    it('should set extensionName property for extension commands', async () => {
        const extensionDir = path.join(projectRoot, '.qwen', 'extensions', 'prefix-ext');
        const extensionConfig = {
            name: 'prefix-ext',
            version: '1.0.0',
        };
...
//# sourceMappingURL=FileCommandLoader-extension.test.js.map