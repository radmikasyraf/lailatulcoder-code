...
import type { WorkspaceEntry, WorkspaceRegistry, WorkspaceRuntime } from './workspace-registry.js';
export interface WorkspaceRouteContext {
    readonly runtime: WorkspaceRuntime;
    readonly routePrefix: string;
}
export declare function resolveWorkspaceEntryFromParam(registry: WorkspaceRegistry, req: Request, res: Response, paramName?: string): WorkspaceEntry | null;
...
export declare function resolveWorkspaceRuntimeWithLiveCompatibilityFromParam(registry: WorkspaceRegistry, req: Request, res: Response, paramName?: string): WorkspaceRuntime | null;
export declare function sendConversationRuntimeUnavailable(res: Response): void;
export declare function sendWorkspaceRuntimeUnavailable(res: Response, entry?: Pick<WorkspaceEntry, 'workspaceCwd' | 'workspaceId'>): void;
export declare function isGenerationClosedError(error: unknown): boolean;
export declare function sendGenerationClosedError(res: Response, error: unknown): boolean;
 ...
 */
export declare function resolveContainedCwd(req: Request, workspaceCwd: string): string;
/**
 ...
 */
export declare function resolveContainedCwdOrFail(req: Request, workspaceCwd: string): string | null;
