...
export function buildVoiceKeyterms(settings) {
...
function canonicalizeKeytermsFile({ filePath, workspaceRoot, mustBeInWorkspace, }) {
...
function readRegularFileNoFollow({ filePath, stat: expectedStat, }) {
    let fd;
    try {
