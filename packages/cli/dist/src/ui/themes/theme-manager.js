...
class ThemeManager {
     ...
     *   LailatulCoder Dark or LailatulCoder Light accordingly.
     ...
     * the corresponding LailatulCoder theme.
    ...
    getAvailableThemes() {
        ...
        // Combine LailatulCoder themes first, then sorted others
        return [...lailatulcoderThemes, ...sortedOtherThemes];
    }
    /**
