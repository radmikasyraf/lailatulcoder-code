...
export const DEFAULT_WINDOW_TITLE = 'LailatulCoder';
const MULTIPLEXER_ENV_KEYS = ['TMUX', 'STY', 'ZELLIJ', 'DVTM'];
 ...
 *  3. DEFAULT_WINDOW_TITLE ('LailatulCoder')
 *
...
export function computeWindowTitle(folderName) {
    return sanitizeWindowTitle(process.env['CLI_TITLE'] || `LailatulCoder - ${folderName || DEFAULT_WINDOW_TITLE}`);
}
/**
 ...
 */
export function writeTerminalTitle(write, title) {
 ...
 */
export function formatSessionWindowTitle(sessionName, folderName, statusPrefix = '') {
 ...
 */
export function titleStatusPrefix(streamingState) {
