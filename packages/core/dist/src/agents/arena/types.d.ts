 ...
 */
export declare const ARENA_MAX_AGENTS = 5;
/**
 * Represents the status of an Arena session.
 */
export declare enum ArenaSessionStatus {
...
export interface ArenaModelConfig {
    /** Model identifier (e.g., 'lailatul-coderr-plus', 'gpt-4') */
    modelId: string;
...
export interface ArenaCallbacks {
    ...
    onAgentStatsUpdate?: (agentId: string, stats: Partial<ArenaAgentStats>) => void;
...
/**
 * Convert an agentId (e.g. "arena-xxx/lailatul-coderr-plus") to a filename-safe
 * string by replacing path-unsafe characters with "--".
 */
export declare function safeAgentId(agentId: string): string;
/**
