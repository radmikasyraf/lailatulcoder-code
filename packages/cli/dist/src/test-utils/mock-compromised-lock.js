...
export function mockCompromisedLock() {
    ...
    const lockSpy = vi
        ...
        onCompromised?.(Object.assign(new Error('lock lost'), { code: 'ECOMPROMISED' }));
        return () => Promise.reject(Object.assign(new Error('Lock is already released'), {
            code: 'ERELEASED',
        }));
    });
    return {
...
//# sourceMappingURL=mock-compromised-lock.js.map