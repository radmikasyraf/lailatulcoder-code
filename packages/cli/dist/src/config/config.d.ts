 ...
 */
import { Config, FileDiscoveryService, type LoadServerHierarchicalMemoryOptions, type LoadServerHierarchicalMemoryResponse, type SessionRestoreProjection, type ToolInvocationGuard, type MCPServerConfig } from '@lailatul-coder/lailatul-coder-core';
...
hostPolicy?: {
    ...
    sessionRestore?: {
        projectionSource: (sessionId: string) => Promise<SessionRestoreProjection | undefined>;
    };
}): Promise<Config>;
