...
export function isShellProgressData(display) {
    return (typeof display === 'object' &&
        display !== null &&
        'type' in display &&
        display.type === 'shell_progress');
}
export const MAX_TERMINAL_IMAGE_BYTES = 8 * 1024 * 1024;
export function isTerminalImageDisplay(display) {
    return (typeof display === 'object' &&
        display !== null &&
        'type' in display &&
...
(function (ToolConfirmationOutcome) {
    ...
    ToolConfirmationOutcome["ProceedOnceAndSwitchToDefault"] = "proceed_once_and_switch_to_default";
