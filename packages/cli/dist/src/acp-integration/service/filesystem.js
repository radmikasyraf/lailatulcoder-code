...
import { createDebugLogger, getErrorMessage, isSubpath, } from '@lailatul-coder/lailatul-coder-core';
...
export class AcpFileSystemService {
    ...
    async readTextFile(params) {
        ...
        // unreachable under `LailatulCoder serve`, which advertises this capability as
