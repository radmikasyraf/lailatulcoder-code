import type { ActiveGoal, GoalSnapshotV2, SubagentConfig, McpToolProgressData, ShellProgressData } from '@lailatul-coder/lailatul-coder-core';
/**
...
export type StreamEvent = MessageStartStreamEvent | ContentBlockStartEvent | ContentBlockDeltaEvent | ContentBlockStopEvent | MessageStopStreamEvent | ToolProgressStreamEvent | GoalStateStreamEvent | ActiveGoalStreamEvent;
 ...
 */
export type CLIMessage = CLIUserMessage | CLIAssistantMessage | CLISystemMessage | CLIResultMessage | CLIPartialAssistantMessage;
/**
 * Type guard functions for message discrimination
 */
export declare function isCLIUserMessage(msg: any): msg is CLIUserMessage;
export declare function isCLIAssistantMessage(msg: any): msg is CLIAssistantMessage;
export declare function isCLISystemMessage(msg: any): msg is CLISystemMessage;
export declare function isCLIResultMessage(msg: any): msg is CLIResultMessage;
export declare function isCLIPartialAssistantMessage(msg: any): msg is CLIPartialAssistantMessage;
 ...
 */
export declare function isTextBlock(block: any): block is TextBlock;
export declare function isThinkingBlock(block: any): block is ThinkingBlock;
export declare function isToolUseBlock(block: any): block is ToolUseBlock;
