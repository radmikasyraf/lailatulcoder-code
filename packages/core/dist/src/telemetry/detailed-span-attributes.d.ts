...
export declare function areSensitiveSpanAttributesEnabled(config: Config): boolean;
export declare function truncateContent(content: string, maxSize?: number, originalLength?: number): {
    content: string;
    truncated: boolean;
};
export declare function addAgentInputMessageAttributes(config: Config, span: Span, promptText: string): void;
export declare function addAgentOutputMessageAttributes(config: Config, span: Span, responseText: string, finishReason: string): void;
export declare class AgentOutputMessageCapture {
 ...
 */
export declare function addModelOutputAttributes(config: Config, span: Span, responseText: string | undefined, originalLengthOrFinishReason?: number | string, finishReason?: string): void;
/**
 ...
 */
export declare function addToolInputAttributes(config: Config, span: Span, _toolName: string, toolInput: string): void;
/**
 ...
 */
export declare function addToolResultAttributes(config: Config, span: Span, _toolName: string, toolResult: string): void;
export declare function addToolArgumentsAttributes(config: Config, span: Span, argumentsValue: unknown): void;
export declare function addToolCallResultAttributes(config: Config, span: Span, result: unknown): void;
/**
