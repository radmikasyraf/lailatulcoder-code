...
export declare const MAX_NOTIFICATION_OUTPUT_TAIL_BYTES = 8192;
/**
 ...
 */
export declare function statusFilePathFor(outputFile: string): string;
...
export type BackgroundShellNotificationCallback = (displayText: string, modelText: string, meta: ShellNotificationMeta) => void;
/**
...
export declare class BackgroundShellRegistry {
    ...
    setNotificationCallback(cb: BackgroundShellNotificationCallback | undefined): void;
    /**
