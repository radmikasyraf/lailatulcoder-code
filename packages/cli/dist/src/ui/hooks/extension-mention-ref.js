...
import { buildExtensionRef, sanitizeDisplayText, } from '../../utils/extension-mention.js';
/**
 ...
 */
export function getExtensionSuggestions(config, pattern) {
    if (!config)
        return [];
...
//# sourceMappingURL=extension-mention-ref.js.map