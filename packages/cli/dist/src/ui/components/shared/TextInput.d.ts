...
export declare function TextInput({ value, onChange, onSubmit, onTab, onUp, onDown, placeholder, height, isActive, validationErrors, inputWidth, initialCursorOffset, ellipsizeOverflow, }: TextInputProps): import("react").JSX.Element | null;
