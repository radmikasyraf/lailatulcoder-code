...
import { type Config, type GoalStateCause, type GoalStateResponse } from '@lailatul-coder/lailatul-coder-core';
import { CommandKind, type GoalCommandOperation, type SlashCommand, type ExecutionMode } from './ui/commands/types.js';
