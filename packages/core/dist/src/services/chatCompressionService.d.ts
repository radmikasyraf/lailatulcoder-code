 ...
 */
export declare const COMPACTION_BUDGET_SAFETY_MARGIN = 1024;
/**
 ...
 */
export declare function computeCompactionOutputBudget(estimatedInputTokens: number, contextLimit: number): number;
/**
