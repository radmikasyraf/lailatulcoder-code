...
export declare const STATUS_LINE_PRESET_ITEM_IDS: readonly ["project-name", "git-branch", "model-with-reasoning", "model", "context-remaining", "total-input-tokens", "total-output-tokens", "current-dir", "pull-request-number", "branch-changes", "context-used", "run-state", "qwen-version", "context-window-size", "used-tokens", "session-id"];
...
export type StatusLinePresetReasoning = false | {
...
export declare function orderStatusLinePresetItems(items: readonly unknown[]): StatusLinePresetItemId[];
...
export declare function formatModelWithReasoning(modelDisplayName: string, reasoning: StatusLinePresetReasoning): string;
