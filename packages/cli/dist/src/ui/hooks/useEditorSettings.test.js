...
import { checkHasEditorType, allowEditorTypeInSandbox, } from '@lailatul-coder/lailatul-coder-core';
...
describe('useEditorSettings', () => {
    ...
    it('should handle editor selection successfully', () => {
        ...
        const { result } = renderHook(() => useEditorSettings(mockLoadedSettings, mockSetEditorError, mockAddItem, config));
        ...
        expect(mockLoadedSettings.setValue).toHaveBeenCalledWith(scope, 'general.preferredEditor', editorType);
    ...
    it('should handle clearing editor preference (undefined editor)', () => {
        ...
        expect(mockLoadedSettings.setValue).toHaveBeenCalledWith(scope, 'general.preferredEditor', undefined);
        expect(mockAddItem).toHaveBeenCalledWith({
            type: MessageType.INFO,
