 ...
 */
import { type ActiveWorkHoldCategory, type ActiveWorkHoldV1 } from '@lailatul-coder/acp-bridge/bridgeTypes';
/**
...
export declare class ActiveWorkReporter {
    ...
    constructor(send: SendNotification, listSources: () => Iterable<ActiveWorkSource>, intervalMs: number, enabledCategories: readonly ActiveWorkHoldCategory[]);
    /**
