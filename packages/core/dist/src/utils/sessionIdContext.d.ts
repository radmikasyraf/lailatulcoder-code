...
export declare function registerSessionModel(sessionId: string, model: string, identity?: string): void;
export declare function getSessionModel(sessionId: string): string | undefined;
export declare function getSessionModelIdentity(sessionId: string): string | undefined;
/**
