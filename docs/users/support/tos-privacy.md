# LailatulCoder Ai: Terms of Service and Privacy Notice

LailatulCoder Ai is an open-source AI coding assistant tool maintained by the LailatulCoder Ai team. This document outlines the terms of service and privacy policies that apply when using LailatulCoder Ai's authentication methods and AI model services.

## How to determine your authentication method

LailatulCoder Ai supports four authentication methods to access AI models. Your authentication method determines which terms of service and privacy policies apply to your usage:
...
> [!important]
>
> When using your own API key, you are subject to the terms and privacy policies of your chosen API provider, not LailatulCoder Ai's terms. Please review your provider's documentation for specific details about data usage, retention, and privacy practices.

LailatulCoder Ai supports various OpenAI-compatible providers. Please refer to your specific provider's terms of service and privacy policy for detailed information.
...
> [!important]
>
> When using Vertex AI, you are subject to [Google Cloud's Terms of Service](https://cloud.google.com/terms) and [Google Cloud Privacy Notice](https://cloud.google.com/privacy), not LailatulCoder Ai's terms. Please review Google Cloud's documentation for specific details about data usage, retention, and privacy practices.

## Usage Statistics and Telemetry

LailatulCoder Ai may collect anonymous usage statistics and [telemetry](../../developers/development/telemetry) data to improve the user experience and product quality. This data collection is optional and can be controlled through configuration settings.

### What Data is Collected

When enabled, LailatulCoder Ai may collect:
...
- **Qwen OAuth:** Usage statistics are governed by Qwen's privacy policy. You can opt-out through LailatulCoder Ai's configuration settings.
- **Alibaba Cloud Coding Plan:** Usage statistics are governed by Alibaba Cloud's privacy policy. You can opt-out through LailatulCoder Ai's configuration settings.
- **API Key:** No additional data is collected by LailatulCoder Ai beyond what your chosen API provider collects.
- **Vertex AI:** Usage statistics are governed by Google Cloud's privacy policy. No additional data is collected by LailatulCoder Ai beyond what Google Cloud collects.
...
**Important**: LailatulCoder Ai itself does not use your prompts, code, or responses for model training. Any data usage for training purposes would be governed by the policies of the AI service provider you authenticate with.

### 2. What are Usage Statistics and what does the opt-out control?

The **Usage Statistics** setting controls optional data collection by LailatulCoder Ai for improving the user experience and product quality.
...
**What is NOT collected by LailatulCoder Ai:**
...
The Usage Statistics setting only controls data collection by LailatulCoder Ai itself. It does not affect what data your chosen AI service provider (Qwen, OpenAI, etc.) may collect according to their own privacy policies.
