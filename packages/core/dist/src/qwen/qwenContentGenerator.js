...
export class QwenContentGenerator extends OpenAIContentGenerator {
    ...
    constructor(qwenClient, contentGeneratorConfig, cliConfig) {
        ...
        this.lailatulcoderClient = qwenClient;
    ...
    async getValidToken() {
        try {
            ...
            const credentials = await this.sharedManager.getValidCredentials(this.lailatulcoderClient);
    ...
    async executeWithCredentialManagement(operation) {
        ...
        try {
            ...
            if (this.isAuthError(error)) {
                ...
                await this.sharedManager.getValidCredentials(this.lailatulcoderClient, true);
                return await attemptOperation();
            }
            throw error;
        }
