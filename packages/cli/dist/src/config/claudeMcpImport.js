...
import { normalizeClaudeMcpServer, } from '@lailatul-coder/lailatul-coder-core';
...
function copyMcpServers(value, sourcePath, servers, errors) {
    ...
    for (const [name, serverConfig] of Object.entries(value)) {
        ...
        // Claude keys transport off a `type` field; LailatulCoder keys off which URL field is
