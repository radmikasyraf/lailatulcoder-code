...
export interface SkillConfig {
     ...
     * `fast`, bare model ID (e.g., `lailatul-coderr-plus`),
 ...
 * disabled.
 */
export declare function parseUserInvocableField(frontmatter: Record<string, unknown>): boolean | undefined;
/**
 ...
 */
export declare function parseAllowedToolsField(frontmatter: Record<string, unknown>): string[] | undefined;
/**
