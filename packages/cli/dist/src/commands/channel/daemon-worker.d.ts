...
import type { ChannelAgentBridge, ChannelWebhookRunOptions, ChannelWebhookTask, DaemonChannelLoopMcpHost, DaemonChannelSessionClient, DaemonChannelSessionFactory } from '@lailatul-coder/channel-base';
...
interface DaemonSessionClientStaticLike {
    ...
    resume(client: DaemonClientLike, sessionId: string, req: {
        workspaceCwd: string;
        modelServiceId?: string;
        sessionScope: 'thread';
        approvalMode?: string;
