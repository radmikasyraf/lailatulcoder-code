...
import { SessionService, buildSessionRecoveryPlan, } from '@lailatul-coder/lailatul-coder-core';
...
export function useResumeCommand(options) {
    ...
    const { config, settings, historyManager, loadHistory: loadHistoryOverride, startNewSession, clearPendingState, setSessionName, remount, } = options;
