...
export class ImageTokenizer {
    /** 28x28 pixels = 1 token */
    static PIXELS_PER_TOKEN = 28 * 28;
    /** Minimum tokens per image */
    static MIN_TOKENS_PER_IMAGE = 4;
     ...
     */
    async extractDimensions(buffer, mimeType) {
     ...
     */
    calculateTokensWithScaling(width, height) {
     ...
     */
    async calculateTokensBatch(base64DataArray) {
        const results = [];
        for (const { data, mimeType } of base64DataArray) {
            try {
                ...
                results.push(ImageTokenizer.MIN_TOKENS_PER_IMAGE +
...
//# sourceMappingURL=imageTokenizer.js.map