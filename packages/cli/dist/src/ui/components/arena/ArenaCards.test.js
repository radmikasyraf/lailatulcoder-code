...
describe('ArenaSessionCard', () => {
    it('renders the comparison summary sections from agent results', () => {
        ...
        const { lastFrame } = renderWithProviders(_jsx(ArenaSessionCard, { sessionStatus: "idle", task: "Refactor authentication", totalDurationMs: 12_000, agents: agents, width: 100 }));
    ...
    it('hides empty per-agent unique file groups', () => {
        ...
        const { lastFrame } = renderWithProviders(_jsx(ArenaSessionCard, { sessionStatus: "idle", task: "Create a reader", totalDurationMs: 10_000, agents: agents, width: 100 }));
        const output = lastFrame();
...
//# sourceMappingURL=ArenaCards.test.js.map