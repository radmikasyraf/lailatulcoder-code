...
import { type BudgetContext, type ReviewBudget } from './budget.js';
 ...
 */
export declare function buildPlanReport(plan: DiffPlan, postImageLines: ((path: string) => number) | null, context: BudgetContext): PlanReport;
/**
