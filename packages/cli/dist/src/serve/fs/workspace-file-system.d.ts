 ...
 */
import { type Ignore, type WriteTextFileOptions } from '@lailatul-coder/lailatul-coder-core';
...
export declare const OWNER_ONLY_NEW_FILE_MODE = 384;
/**
 ...
 */
export declare function resolveNewFileModeBits(policy: NewFileModePolicy, umask?: number): number;
...
export interface WorkspaceFileSystem {
     ...
     */
    writeTextOverwrite(p: ResolvedPath, content: string, opts?: WriteTextFileOptions): Promise<WriteTextAtomicOutcome>;
     ...
     */
    writeBytesAtomic(p: ResolvedPath, data: Buffer): Promise<{
        sizeBytes: number;
        hash: ContentHash;
    }>;
    /**
...
export interface WorkspaceFileSystemFactory {
    ...
    writeSameHostToolText?(ctx: RequestContext, request: SameHostToolTextWriteRequest): Promise<void>;
}
