...
export declare const CONTEXT_FILES_ANNOUNCEMENT_PREFIX = "Read context files:";
/** Whether a history item is the context-files announcement. */
export declare function isContextFilesAnnouncement(item: {
    type: string;
    text?: string;
}): boolean;
/**
...
export declare const SLASH_COMMANDS_SKIP_RECORDING: ReadonlySet<string>;
export declare const getSlashCommandFirstToken: (query: string) => string;
 ...
 */
export declare function consumesContextAnnouncementLatch(trimmedPrompt: string, options: {
