...
import { ACTIVE_WORK_HEARTBEAT_VERSION, ACTIVE_WORK_NOTIFICATION_METHOD, } from '@lailatul-coder/acp-bridge/bridgeTypes';
...
export class ActiveWorkReporter {
    ...
    #disposed = false;
    #enabledCategories;
    constructor(send, listSources, intervalMs, enabledCategories) {
        this.send = send;
