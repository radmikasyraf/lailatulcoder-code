 ...
 */
import type { CompactionThresholds, CompressionStatus, MCPServerConfig, ThoughtSummary, ToolCallConfirmationDetails, ToolConfirmationOutcome, ToolResultDisplay, AgentStatus, ArenaDiffSummary, GoalSnapshotV2, GoalStateCause } from '@lailatul-coder/lailatul-coder-core';
...
export declare const GOAL_STATUS_KINDS: readonly ["set", "achieved", "cleared", "failed", "aborted", "paused", "checking"];
/** Narrows an untrusted value (e.g. a persisted transcript field). */
export declare function isGoalStatusKind(value: unknown): value is GoalStatusKind;
export declare const TERMINAL_GOAL_STATUS_KINDS: readonly ["achieved", "aborted", "failed"];
export declare function isTerminalGoalStatusKind(kind: GoalStatusKind): kind is (typeof TERMINAL_GOAL_STATUS_KINDS)[number];
...
export type HistoryItemWithoutId = HistoryItemUser | HistoryItemNotification | HistoryItemUserShell | HistoryItemGemini | HistoryItemGeminiContent | HistoryItemGeminiThought | HistoryItemGeminiThoughtContent | HistoryItemInfo | HistoryItemError | HistoryItemWarning | HistoryItemSuccess | HistoryItemRetryCountdown | HistoryItemVisionNotice | HistoryItemAbout | HistoryItemHelp | HistoryItemToolGroup | HistoryItemToolUseSummary | HistoryItemStats | HistoryItemModelStats | HistoryItemToolStats | HistoryItemSkillStats | HistoryItemQuit | HistoryItemCompression | HistoryItemSummary | HistoryItemCompression | HistoryItemExtensionsList | HistoryItemToolsList | HistoryItemSkillsList | HistoryItemMcpStatus | HistoryItemContextUsage | HistoryItemArenaAgentComplete | HistoryItemArenaSessionComplete | HistoryItemInsightProgress | HistoryItemBtw | HistoryItemAdvisor | HistoryItemMemorySaved | HistoryItemAwayRecap | HistoryItemUserPromptSubmitBlocked | HistoryItemStopHookLoop | HistoryItemStopHookSystemMessage | HistoryItemDoctor | HistoryItemDiffStats | HistoryItemGoalStatus | HistoryItemGoalState;
 ...
 */
export declare const isHistoryItemVisibleAfterRestore: (item: Pick<HistoryItem, "display">) => boolean;
