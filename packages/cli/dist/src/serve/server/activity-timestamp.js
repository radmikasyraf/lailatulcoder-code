 ...
 */
export function laterActivityTimestamp(live, persisted) {
    const liveTime = live === undefined ? Number.NaN : Date.parse(live);
    const persistedTime = persisted === undefined ? Number.NaN : Date.parse(persisted);
...
//# sourceMappingURL=activity-timestamp.js.map