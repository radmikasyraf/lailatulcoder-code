...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    // @lailatul-coder/lailatul-coder-core is a peer dependency of @lailatul-coder/webui.
    // Since @lailatul-coder/webui marks it as external in its own Vite build, the
    ...
    // '@lailatul-coder/lailatul-coder-core/src/core/tokenLimits.js') are also excluded;
