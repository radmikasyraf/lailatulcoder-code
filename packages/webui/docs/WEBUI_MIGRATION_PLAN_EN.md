...
1. Extract components from `vscode-ide-companion/src/webview/` into an independent `@lailatul-coder/webui` package
...
```typescript
// @lailatul-coder/webui/src/context/PlatformContext.ts
...
```javascript
// @lailatul-coder/webui/tailwind.preset.js
module.exports = {
  theme: {
    extend: {
      colors: {
...
module.exports = {
  presets: [require('@lailatul-coder/webui/tailwind.preset')],
  content: [
    './src/**/*.{ts,tsx}',
    './node_modules/@lailatul-coder/webui/dist/**/*.js',
  ],
};
```
...
```
Developer ──► @lailatul-coder/webui ──► vscode-ide-companion
  │              │                      │
...
// After: Update import
import { FileIcon } from '@lailatul-coder/webui';
// or import { FileIcon } from '@lailatul-coder/webui/icons';
```
...
1. **Tailwind Class Name Tree Shaking**
   ...
   - Solution: Consumer's `content` config needs to include `node_modules/@lailatul-coder/webui`
...
│     └── Edit files in @lailatul-coder/webui/src/                     │
│                                                                  │
...
│     └── import { Component } from '@lailatul-coder/webui'            │
...
1. **Single Source of Truth**: All UI components live in `@lailatul-coder/webui`
