 ...
 */
export function useTurnDiffs(history, fileHistoryService, enabled) {
...
function previewOfUserItem(item) {
    if (!item.text)
        return '';
...
//# sourceMappingURL=useTurnDiffs.js.map