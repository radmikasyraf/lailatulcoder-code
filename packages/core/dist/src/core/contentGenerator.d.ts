...
/** @internal */
export declare function preloadContentGenerator(generator: ContentGenerator): Promise<void>;
/** @internal */
export declare function resetPreloadedContentGenerator(generator: ContentGenerator | undefined): void;
