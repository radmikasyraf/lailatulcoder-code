...
export const clampDialogHeight = (height) => height === undefined ? undefined : Math.max(1, Math.floor(height));
/**
 ...
 * settles.
 */
export const getDialogMaxHeight = (terminalHeight, staticExtraHeight) => Math.max(1, terminalHeight - staticExtraHeight - MAIN_CONTENT_HEIGHT_RESERVATION);
