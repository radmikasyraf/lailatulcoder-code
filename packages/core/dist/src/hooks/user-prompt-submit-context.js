 ...
 */
export { USER_PROMPT_SUBMIT_CONTEXT_OPEN as USER_PROMPT_SUBMIT_CONTEXT_OPEN_TAG, USER_PROMPT_SUBMIT_CONTEXT_CLOSE as USER_PROMPT_SUBMIT_CONTEXT_CLOSE_TAG, isUserPromptSubmitContextPartText, wrapUserPromptSubmitContext, } from '../utils/transcript-records.js';
/**
 ...
 */
export function stripTrailingUserPromptSubmitContextPart(parts) {
    if (parts.length <= 1) {
        return parts;
    }
...
//# sourceMappingURL=user-prompt-submit-context.js.map