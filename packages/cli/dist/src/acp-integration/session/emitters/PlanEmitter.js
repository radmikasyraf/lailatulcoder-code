...
import { createTranscriptPlanUpdate, extractTranscriptTodoPlan, } from '@lailatul-coder/acp-bridge/transcriptReplay';
/**
...
export class PlanEmitter extends BaseEmitter {
    ...
    async emitPlan(plan, sourceCallId) {
        ...
        await this.sendUpdate(createTranscriptPlanUpdate(plan.todos, cumulative, {
