...
describe('omitSkillDetailsFromReplayArrays', () => {
    it('redacts both arrays when both are present', () => {
        ...
        expect(shaped.compactedReplay[0].data.update._meta).not.toHaveProperty('availableSkillDetails');
        expect(shaped.liveJournal[0].data._meta).not.toHaveProperty('availableSkillDetails');
    });
...
//# sourceMappingURL=skill-details-redaction.test.js.map