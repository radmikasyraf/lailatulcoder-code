 ...
 */
export declare const RUN_EPOCH_SLACK_MS = 2000;
/**
 ...
 */
export declare function runEpochMs(planPath: string): number;
/**
...
export declare function recordedPromptPath(planPath: string, key: string): string;
