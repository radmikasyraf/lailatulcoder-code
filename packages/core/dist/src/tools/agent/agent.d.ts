 ...
 */
export declare function rebuildToolRegistryOnOverride(override: Config, base: Config): Promise<void>;
/**
 ...
 */
export declare function createApprovalModeOverride(base: Config, mode: ApprovalMode, options?: ApprovalModeOverrideOptions): Promise<ApprovalModeOverrideHandle>;
/**
...
declare class AgentToolInvocation extends BaseToolInvocation<AgentParams, ToolResult> {
    ...
    private callId?;
    constructor(config: Config, subagentManager: SubagentManager, params: AgentParams, forkProfile?: ForkProfile | undefined);
