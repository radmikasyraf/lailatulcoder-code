...
export const EVENT_REPEATED_TOOL_FAILURE_GUARD = 'lailatul-coder.repeated_tool_failure_guard';
...
export const EVENT_RIPGREP_RUNTIME_RECOVERY = 'lailatul-coder.ripgrep_runtime_recovery';
...
export const EVENT_CONTENT_RETRY_FAILURE = 'lailatul-coder.chat.content_retry_failure';
export const EVENT_PROTOCOL_TAG_SANITIZED = 'lailatul-coder.chat.protocol_tag_sanitized';
...
export const EVENT_MALFORMED_JSON_RESPONSE = 'lailatul-coder.malformed_json_response';
...
export const TOOL_FAILURE_KIND_INVOCATION_GUARD_DENIED = 'invocation_guard_denied';
...
export const TOOL_FAILURE_KIND_NON_INTERACTIVE_DENIED = 'non_interactive_denied';
export const TOOL_FAILURE_KIND_BACKGROUND_AGENT_DENIED = 'background_agent_denied';
