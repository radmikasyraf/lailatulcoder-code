 ...
 */
import { type LiveTaskToolName, type LiveTaskToolRequestInfo } from '@lailatul-coder/acp-bridge/bridgeOptions';
...
export declare function isLiveTaskToolName(value: string): value is LiveTaskToolName;
