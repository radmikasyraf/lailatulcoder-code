...
export type PersistedSessionArtifactKind = 'file' | 'link' | 'html' | 'image' | 'video' | 'audio' | 'pdf' | 'notebook' | 'document' | 'other';
...
export declare function selectActiveSideArtifactRecordUuids(records: ReadonlyArray<SessionArtifactChatRecordLike & {
    uuid: string;
    parentUuid: string | null;
}>, activeRecordUuids: readonly string[]): string[];
...
export declare class SessionArtifactSnapshotAccumulator {
