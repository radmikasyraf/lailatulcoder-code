...
import { getApprovalModeIndicatorColor, getApprovalModePromptStyle, } from './approvalModeVisuals.js';
describe('approval mode visuals', () => {
    it('uses distinct colors for auto-edit and classifier auto mode', () => {
        expect(getApprovalModeIndicatorColor(ApprovalMode.AUTO_EDIT)).toBe(theme.status.warning);
        expect(getApprovalModeIndicatorColor(ApprovalMode.AUTO)).toBe(theme.text.link);
    });
...
//# sourceMappingURL=approvalModeVisuals.test.js.map