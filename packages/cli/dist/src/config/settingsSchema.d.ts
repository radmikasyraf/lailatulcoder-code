 ...
 */
import type { MCPServerConfig, BugCommandSettings, TelemetrySettings, OutboundCorrelationSettings, AuthType, ChatCompressionSettings, ModelProvidersConfig, ProviderProtocolConfig } from '@lailatul-coder/lailatul-coder-core';
...
declare const SETTINGS_SCHEMA: {
    ...
    readonly general: {
        ...
        readonly properties: {
            ...
            readonly gitCoAuthor: {
                ...
                readonly description: "Attribution added to git commits and pull requests created through LailatulCoder Ai.";
                readonly showInDialog: false;
                ...
                readonly properties: {
                    readonly commit: {
                        ...
                        readonly requiresRestart: false;
                        readonly default: true;
                        readonly description: "Add a Co-authored-by trailer to git commit messages AND attach a per-file AI-attribution git note (`refs/notes/ai-attribution`) for commits made through LailatulCoder Ai. Disabling skips both.";
                        readonly showInDialog: true;
                    };
                    readonly pr: {
                        readonly type: "boolean";
                        ...
                        readonly requiresRestart: false;
                        readonly default: true;
                        readonly description: "Append a LailatulCoder Ai attribution line to PR descriptions when running `gh pr create`.";
                        readonly showInDialog: true;
                    };
                };
            };
            ...
            readonly preventSystemSleep: {
                ...
                readonly requiresRestart: true;
                readonly default: true;
                readonly description: "Prevent the system from sleeping while LailatulCoder Ai is streaming a model response or executing tools. Idle prompt time and permission prompts do not inhibit sleep.";
                readonly showInDialog: true;
            };
    ...
    readonly ui: {
        ...
        readonly properties: {
            ...
            readonly showStatusInTitle: {
                ...
                readonly requiresRestart: false;
                readonly default: true;
                readonly description: "Show LailatulCoder Ai session name and status in the terminal window title";
                readonly showInDialog: true;
            };
            readonly hideTips: {
                readonly type: "boolean";
            ...
            readonly customBannerTitle: {
                ...
                readonly requiresRestart: false;
                readonly default: string;
                readonly description: "Replace the default \">_ LailatulCoder Ai\" title shown in the banner info panel. The version suffix is always appended.";
                readonly showInDialog: false;
            };
    ...
    readonly outboundCorrelation: {
        ...
        readonly description: "SECURITY-RELEVANT. Controls what client-side correlation data lailatul-coder writes into outbound LLM API requests (DashScope, OpenAI, Anthropic, etc.) — separate from `telemetry.*` which governs data flow into the operator's OWN OTLP collector. All values default to off. Opt in only when the LLM provider also reports into your OTel collector for cross-process trace stitching (e.g. ARMS Tracing + DashScope).";
        readonly showInDialog: false;
        readonly jsonSchemaOverride: {
            readonly type: "object";
            readonly properties: {
                readonly propagateTraceContext: {
                    readonly description: "Requires `telemetry.enabled: true`. Inject W3C `traceparent` on outbound `fetch` requests (LLM SDK calls, MCP StreamableHTTP, WebFetch, ...) AND as a `TRACEPARENT` environment variable in shell child processes (Bash tool, hooks, monitor). When enabled, any existing `TRACEPARENT` in the parent environment is overwritten with lailatul-coder's own trace context. Default: false — trace context stays internal to the operator's OTLP collector. Set true when you want cross-process trace stitching with an OTel-aware LLM provider (e.g. ARMS+DashScope) or need shell scripts / CLI tools to participate in distributed tracing.";
                    readonly type: "boolean";
                    readonly default: false;
                };
            };
    ...
    readonly advisorModel: {
        readonly type: "string";
        readonly label: "Advisor Model";
        readonly category: "Model";
        readonly requiresRestart: false;
        readonly default: string;
        readonly description: "Model used by /advisor for second-opinion reviews of the conversation. Leave empty to use the main model. A model at least as capable as the main model is recommended. Setting this sends the recent conversation transcript to that model, even when it uses another provider.";
        readonly showInDialog: true;
    };
            ...
            readonly generationConfig: {
                ...
                readonly properties: {
                    ...
                    readonly splitToolMedia: {
                        ...
                        readonly requiresRestart: false;
                        readonly default: true;
                        readonly description: "When true, media (images / audio / video / files) returned by tool calls — including the built-in read_file and MCP tools — is split into a follow-up user message instead of being embedded in the `role: \"tool\"` message. The OpenAI Chat Completions spec only permits text on tool messages, so strict OpenAI-compatible servers (e.g., doubao / new-api / LM Studio) silently drop or reject embedded media and the model never sees an image read via read_file (LailatulCoder/lailatul-coder#4876, #3616). Default true is spec-compliant and safe for permissive providers; set false only to restore the legacy embed-in-tool-message behavior.";
                        readonly parentKey: "generationConfig";
                        readonly showInDialog: false;
                    };
                    readonly toolResultContentFormat: {
                        ...
                        readonly description: "Controls how text-only tool results are serialized in OpenAI-compatible requests. Use \"parts\" for the default content-part array shape. Use \"string\" only for legacy OpenAI-compatible runtimes whose tool templates ignore text content parts (for example older GLM-5.1 vLLM/SGLang templates; LailatulCoder/lailatul-coder#3361). Tool-returned media is still handled by splitToolMedia.";
                        readonly parentKey: "generationConfig";
                        readonly showInDialog: false;
                        readonly options: readonly [{
                    ...
                    readonly contextWindowSize: {
                        ...
                        readonly description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from LailatulCoder Ai's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.";
                        readonly parentKey: "generationConfig";
                        readonly showInDialog: false;
                    };
                };
    ...
    readonly tools: {
        ...
        readonly properties: {
            ...
            readonly listDirectory: {
                ...
                readonly requiresRestart: true;
                readonly default: {};
                readonly description: "Settings for the built-in list_directory tool. Opt-in: the tool is disabled by default because glob covers directory listing in most cases.";
                readonly showInDialog: false;
                readonly properties: {
                    readonly enabled: {
                        readonly type: "boolean";
                        readonly label: "Enable ListDirectory";
                        readonly category: "Tools";
                        readonly requiresRestart: true;
                        readonly default: false;
                        readonly description: "Enable the built-in list_directory tool. Disabled by default; it is also re-enabled automatically when explicitly listed in the coreTools allowlist (--core-tools / tools.core).";
                        readonly showInDialog: true;
                    };
                };
            };
            ...
            readonly computerUse: {
                ...
                readonly properties: {
                    ...
                    readonly idleTimeoutMs: {
                        ...
                        readonly minimum: 0;
                        readonly maximum: 2147483647;
                        readonly description: "Milliseconds to keep the cua-driver process alive after the last computer_use__* call. The default is 300000 (5 minutes). Set to 0 to keep it running until lailatul-coder exits.";
                        readonly showInDialog: false;
                    };
    ...
    readonly stopHookBlockingCap: {
        ...
        readonly requiresRestart: true;
        readonly default: 8;
        readonly description: "Maximum consecutive blocking Stop/SubagentStop hook decisions before LailatulCoder Ai overrides the hook loop and ends the turn. Can be overridden by QWEN_CODE_STOP_HOOK_BLOCK_CAP.";
        readonly showInDialog: false;
        readonly jsonSchemaOverride: {
            readonly type: "integer";
            readonly minimum: 1;
