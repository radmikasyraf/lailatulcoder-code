...
import { createDebugLogger, fetchGitDiff, fetchGitDiffHunks, } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export function useDiffData(cwd) {
    const [result, setResult] = useState(null);
    const [hunks, setHunks] = useState(new Map());
...
//# sourceMappingURL=useDiffData.js.map