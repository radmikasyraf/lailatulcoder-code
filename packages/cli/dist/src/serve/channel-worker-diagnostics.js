...
export function normalizeWorkerDiagnostic(value) {
    return stripAnsi(value)
        .replace(WORKER_LOG_INVISIBLE_RE, '')
        .replace(WORKER_LOG_CONTROL_RE, '');
}
export function createWorkerDiagnosticRedactor(opts) {
...
export function sanitizeWorkerDiagnostic(value, maxLength, opts) {
...
//# sourceMappingURL=channel-worker-diagnostics.js.map