 ...
 */
import { buildUsageDashboard, loadUsageHistoryWithLive, } from '@lailatul-coder/lailatul-coder-core';
...
export function registerUsageStatsRoutes(app, deps = {}) {
    ...
    app.get('/usage/dashboard', async (req, res) => {
        ...
        try {
            ...
            writeStderrLine(`LailatulCoder serve: GET /usage/dashboard failed: ${err instanceof Error ? err.message : String(err)}`);
            res.status(500).json({
