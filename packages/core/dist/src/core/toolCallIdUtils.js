...
const toolCallFingerprintCache = new WeakMap();
 ...
 */
export function getCachedToolCallFingerprint(carrier, name, args) {
...
export function getFunctionCallFingerprint(functionCall) {
    return getCachedToolCallFingerprint(functionCall, functionCall.name, functionCall.args);
}
/**
 ...
 */
export function isReplayOfHandledToolCall(handledToolCallFingerprints, providerCallId, fingerprint) {
 ...
 */
export function recordHandledToolCall(handledToolCallFingerprints, providerCallId, fingerprint) {
