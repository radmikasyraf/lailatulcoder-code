...
import { getCurrentGeminiMdFilename } from '@lailatul-coder/lailatul-coder-core';
import { CommandKind } from './types.js';
import { t } from '../../i18n/index.js';
export const initCommand = {
    name: 'init',
    get description() {
        return t('Analyzes the project and creates a tailored LAILATUL.md file.');
    },
    ...
    action: async (context, _args) => {
        ...
        return {
            type: 'submit_prompt',
            content: `
You are LailatulCoder Ai, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
