...
export type RoleId = '0' | '1a' | '1b' | '1c' | '2' | '3a' | '3b' | '3c' | '4' | '5' | '6a' | '6b' | '6c' | '7' | 'test-matrix' | 'invariant-a' | 'invariant-b' | 'invariant-c' | 'verify' | 'reverse-audit';
/**
 ...
 */
export declare const REPOSITORY_CONTEXT_ROLES: readonly ["1a", "1b", "1c", "2", "3a", "3b", "3c", "4", "5", "6a", "6b", "6c", "test-matrix"];
export type RepositoryContextRoleId = (typeof REPOSITORY_CONTEXT_ROLES)[number];
export declare function isRepositoryContextRoleId(value: string): value is RepositoryContextRoleId;
 ...
 */
export declare const REVERSE_AUDIT_EXAMPLE_RECEIPT = "No issues found \u2014 re-walked the reconnect state machine and the two changed exports' call sites; every gap I checked was already in the list";
/**
