 ...
 */
export function sanitizeOscPayload(text) {
 ...
 */
export function encodeKittyPayload(text) {
 ...
 * Format: `\e]9;\n\n<title>:\n<message>\a`
 */
export function oscITerm2Notify(title, message) {
 ...
 */
export function oscKittyNotify(title, message, id) {
    return [
 ...
 */
export function oscGhosttyNotify(title, message) {
