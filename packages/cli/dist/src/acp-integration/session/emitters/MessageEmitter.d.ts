...
import { type GoalRecord, type GoalSnapshotV2, type GoalStateCause } from '@lailatul-coder/lailatul-coder-core';
...
export declare class MessageEmitter extends BaseEmitter {
    ...
    emitGoalStatus(status: Omit<HistoryItemGoalStatus, 'id' | 'type'>, goalState?: unknown): Promise<void>;
