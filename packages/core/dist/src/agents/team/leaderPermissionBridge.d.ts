 ...
 */
import type { ToolCallConfirmationDetails, ToolConfirmationOutcome, ToolConfirmationPayload } from '../../tools/tools.js';
/**
 ...
 */
export declare function registerLeader(callbacks: LeaderApprovalCallbacks): void;
/**
 * Get the currently registered leader callbacks, or null
 * if no leader is registered (startup race / not in a team).
 */
export declare function getLeader(): LeaderApprovalCallbacks | null;
/**
 * Unregister the leader. Called on team delete / cleanup.
 */
export declare function unregisterLeader(): void;
/**
 ...
 */
export declare function forwardApproval(teammateName: string, teammateColor: string | undefined, details: ToolCallConfirmationDetails): boolean;
/**
 ...
 * that callback off.
 */
export declare function wrapConfirmWithBadge(original: Omit<ToolCallConfirmationDetails, 'onConfirm'> & {
    type: ToolCallConfirmationDetails['type'];
}, teammateName: string, respond: (outcome: ToolConfirmationOutcome, payload?: ToolConfirmationPayload) => Promise<void>, _teammateColor?: string): ToolCallConfirmationDetails;
