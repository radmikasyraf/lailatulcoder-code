...
function useTestHarnessForSlashCompletion(enabled, query, slashCommands, commandContext, recentCommands) {
...
describe('useSlashCompletion', () => {
    ...
    describe('Top-Level Commands', () => {
        ...
        it('should not include alias noise for primary-name matches', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/he', slashCommands, mockCommandContext));
            await waitFor(() => {
                expect(result.current.suggestions).toEqual([
                    expect.objectContaining({
                        label: 'help',
        ...
        it('should keep argumentHint out of command suggestion labels', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/fix', slashCommands, mockCommandContext));
            await waitFor(() => {
                expect(result.current.suggestions).toEqual([
                    expect.objectContaining({
                        label: 'fix-issue',
        ...
        it('should prefer higher completionPriority when match quality ties', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/mo', slashCommands, mockCommandContext));
            await waitFor(() => {
        ...
        it('should include command metadata in slash suggestions', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/rev', slashCommands, mockCommandContext));
            await waitFor(() => {
                expect(result.current.suggestions).toEqual([
                    expect.objectContaining({
                        label: 'review',
        ...
        it('should boost recent commands for root slash suggestions', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/', slashCommands, mockCommandContext, recentCommands));
            expect(result.current.suggestions.map((suggestion) => suggestion.value)).toEqual(['beta', 'alpha']);
        });
        it('should boost recent help command above high-priority model for root slash suggestions', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/', slashCommands, mockCommandContext, recentCommands));
            expect(result.current.suggestions.map((suggestion) => suggestion.value)).toEqual(['help', 'model']);
        });
        it('should boost recent commands for non-root prefix suggestions', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/m', slashCommands, mockCommandContext, recentCommands));
            await waitFor(() => {
    ...
    describe('Argument Completion', () => {
        it('should call the command.completion function for argument suggestions', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/config set --project', slashCommands, mockCommandContext));
            await waitFor(() => {
        ...
        it('should map completion items with descriptions for argument suggestions', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/skills ', slashCommands, mockCommandContext));
            await waitFor(() => {
                expect(result.current.suggestions).toEqual([
                    {
                        label: 'pdf',
        ...
        it('should call command.completion with an empty string when args start with a space', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/workspace switch ', slashCommands, mockCommandContext));
            await waitFor(() => {
                expect(mockCompletionFn).toHaveBeenCalledWith(expect.objectContaining({
                    invocation: {
    ...
    describe('isDirectory propagation', () => {
        it('should propagate isDirectory from CommandCompletionItem to Suggestion', async () => {
            ...
            const { result } = renderHook(() => useTestHarnessForSlashCompletion(true, '/dir ', slashCommands, mockCommandContext));
            await waitFor(() => {
