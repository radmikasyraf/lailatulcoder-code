...
The integration tests are designed to validate the end-to-end functionality of LailatulCoder Ai. They execute the built binary in a controlled environment and verify that it behaves as expected when interacting with the file system.
...
The workflow runs the tests in different sandboxing environments to ensure LailatulCoder Ai is tested across each:
