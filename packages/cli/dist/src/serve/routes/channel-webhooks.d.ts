...
import type { ChannelWebhookConfig, ChannelWebhookTask } from '@lailatul-coder/channel-base';
...
export interface ChannelWebhookRouteDeps {
    getChannelsConfig: () => Record<string, {
...
export declare function registerChannelWebhookRoutes(app: Application, deps: ChannelWebhookRouteDeps): void;
