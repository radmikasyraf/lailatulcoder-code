...
export function createHttpExporters(options) {
    ...
    if (logsUrl) {
        ...
        logToSpanProcessor = new LogToSpanProcessor(new OTLPTraceExporterHttp({ url: tracesUrl }), {
...
//# sourceMappingURL=sdk-exporters-http.js.map