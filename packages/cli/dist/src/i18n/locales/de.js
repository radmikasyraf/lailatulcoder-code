...
export default {
  ...
  'Analyzes the project and creates a tailored LAILATUL.md file.':
    'Analysiert das Projekt und erstellt eine maßgeschneiderte LAILATUL.md-Datei.',
  ...
  'How is LailatulCoder doing this session? (optional)':
    'Wie macht sich LailatulCoder in dieser Sitzung? (optional)',
  Bad: 'Schlecht',
  Fine: 'In Ordnung',
  Good: 'Gut',
  Dismiss: 'Ignorieren',
  ...
  'This extension will append info to your LAILATUL.md context using {{fileName}}':
    'Diese Erweiterung wird Informationen zu Ihrem LAILATUL.md-Kontext mit {{fileName}} hinzufügen',
  ...
  'To add hooks, edit settings.json directly or ask LailatulCoder.':
    'Um Hooks hinzuzufügen, bearbeiten Sie settings.json direkt oder fragen Sie LailatulCoder.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask LailatulCoder to help.':
    'Um diesen Hook zu ändern oder zu entfernen, bearbeiten Sie settings.json direkt oder fragen Sie LailatulCoder.',
  // Hooks - Disabled Step
  ...
  'stdout shown to LailatulCoder': 'stdout dem LailatulCoder anzeigen',
  ...
  'Successfully added LAILATUL.md files from the following directories if there are:\n- {{directories}}':
    'LAILATUL.md-Dateien aus folgenden Verzeichnissen erfolgreich hinzugefügt, falls vorhanden:\n- {{directories}}',
  ...
  'Run LailatulCoder --debug to see error logs':
    'Führen Sie LailatulCoder --debug aus, um Fehlerprotokolle anzuzeigen',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Das kostenlose LailatulCoder Auth-Kontingent wurde am 2026-04-15 eingestellt. Bitte wählen Sie Coding Plan oder API Key.',
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'Das kostenlose LailatulCoder Auth-Angebot wurde am 2026-04-15 eingestellt. Bitte wählen Sie ein Modell eines anderen Anbieter oder führen Sie /auth aus, um zu wechseln.',
  '\n⚠ LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Das kostenlose LailatulCoder Auth-Kontingent wurde am 2026-04-15 eingestellt. Bitte wählen Sie eine andere Option.\n',
  ...
  'LailatulCoder Auth Authentication': 'LailatulCoder Auth-Authentifizierung',
  ...
  'LailatulCoder Auth Authentication Timeout':
    'LailatulCoder Auth-Authentifizierung abgelaufen',
  ...
  'Waiting for LailatulCoder Auth authentication...':
    'Warten auf LailatulCoder Auth-Authentifizierung...',
  ...
  'You can resume a previous conversation by running lailatulcoder --continue or lailatulcoder --resume.':
    'Sie können eine frühere Unterhaltung mit lailatulcoder --continue oder lailatulcoder --resume fortsetzen.',
  ...
  'Add a LAILATUL.md file to give LailatulCoder Ai persistent project context.':
    'Fügen Sie eine LAILATUL.md-Datei hinzu, um LailatulCoder Ai dauerhaften Projektkontext zu geben.',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: Navigieren | Enter: Auswählen | Esc: Abbrechen',
  'Authenticate using LailatulCoder Auth': 'Mit LailatulCoder Auth authentifizieren',
  ...
  'Starting LailatulCoder Auth authentication...':
    'LailatulCoder Auth-Authentifizierung wird gestartet...',
  'Successfully authenticated with LailatulCoder Auth.':
    'Erfolgreich mit LailatulCoder Auth authentifiziert.',
  'Failed to authenticate with LailatulCoder Auth: {{error}}':
    'Authentifizierung mit LailatulCoder Auth fehlgeschlagen: {{error}}',
  ...
  '  LailatulCoder auth LailatulCoder-oauth     - Authenticate with LailatulCoder Auth (discontinued)':
    '  LailatulCoder auth LailatulCoder-oauth     - Mit LailatulCoder Auth authentifizieren (eingestellt)',
  'Or simply run:': 'Oder einfach ausführen:',
  '  LailatulCoder auth                - Interactive authentication setup\n':
    '  LailatulCoder auth                - Interaktive Authentifizierungseinrichtung\n',
  '✓ Authentication Method: LailatulCoder Auth':
    '✓ Authentifizierungsmethode: LailatulCoder Auth',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Das kostenlose LailatulCoder Auth-Kontingent wurde am 2026-04-15 eingestellt. Führen Sie /auth aus, um zu Coding Plan, OpenRouter, Fireworks AI oder einem anderen Anbieter zu wechseln.',
  ...
  '  Run `LailatulCoder auth coding-plan` to re-configure.\n':
    '  Führen Sie `LailatulCoder auth coding-plan` aus, um neu zu konfigurieren.\n',
