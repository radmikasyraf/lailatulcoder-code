...
// the file is created.
function identityOfAbsent(path) {
...
export function isSameFile(left, right) {
    ...
    const leftIdentity = leftStat !== undefined ? realpathSync(left) : identityOfAbsent(left);
    const rightIdentity = rightStat !== undefined ? realpathSync(right) : identityOfAbsent(right);
    return leftIdentity === rightIdentity;
}
//# sourceMappingURL=same-file.js.map