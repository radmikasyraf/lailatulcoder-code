 ...
 */
export function convertTomlToMarkdown(tomlContent) {
    let parsed;
    try {
    ...
    // Generate Markdown
    if (description) {
        const frontmatter = stringifyYaml({ description }, { lineWidth: 0 }).trimEnd();
        return `---
${frontmatter}
---
 ...
 */
export function isTomlFormat(content) {
    try {
        toml.parse(content);
        return true;
    }
...
//# sourceMappingURL=toml-to-markdown-converter.js.map