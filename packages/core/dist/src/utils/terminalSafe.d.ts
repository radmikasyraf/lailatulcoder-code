 ...
 */
export declare function isBidiControlChar(code: number): boolean;
/**
 ...
 * same defense.
 */
export declare function stripDisplayControlChars(text: string): string;
/** Max length for a background-notification label shown in the UI. */
export declare const NOTIFICATION_LABEL_MAX_LENGTH = 80;
/**
 ...
 */
export declare function truncateNotificationLabel(label: string): string;
