...
import type { Content, FunctionCall, GenerateContentConfig, FunctionDeclaration } from '@google/genai';
 ...
 */
export declare function extractParentToolNames(generationConfig: GenerateContentConfig | undefined): string[];
/**
...
export declare class AgentCore {
     ...
     */
    runInAgentFrames<T>(fn: () => Promise<T>, inheritedView?: RuntimeContentGeneratorView, inheritedAgentId?: string, inheritedTeammateIdentity?: TeammateIdentity, inheritedAgentDepth?: number): Promise<T>;
    /**
    ...
    private observeSyntheticToolResultProducer;
     ...
     */
    processFunctionCalls(functionCalls: FunctionCall[], abortController: AbortController, promptId: string, currentRound: number, toolsList: FunctionDeclaration[], responseId?: string, wasOutputTruncated?: boolean, handledToolCallFingerprints?: Map<string, string>, duplicateProviderToolCallResponseIds?: Set<string>): Promise<{
        messages: Content[];
