 ...
 */
export declare function WorktreeExitDialog({ slug, branch, worktreePath, originalHeadCommit, onKeep, onRemove, onCancel, }: WorktreeExitDialogProps): import("react").JSX.Element;
export {};
