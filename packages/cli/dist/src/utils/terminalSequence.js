 ...
 */
export function parseAllowedTerminalSequences(input) {
    if (!input)
        return null;
    const tokens = [];
    let position = 0;
...
function parseOscSequence(input, start) {
    ...
    if (!ALLOWED_OSC_CODES.has(oscCode))
        return null;
 ...
 */
export function emitTerminalSequence(sequence, writeRaw) {
...
//# sourceMappingURL=terminalSequence.js.map