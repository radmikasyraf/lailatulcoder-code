...
export interface LiveSessionHostControl {
    setCallState(epoch: number, state: 'starting' | 'listening' | 'thinking' | 'speaking' | 'stopping' | 'error'): boolean;
...
export interface LiveSessionCoordinatorOptions {
    ...
    listRecentSessions?: (runtime: WorkspaceRuntime) => Promise<readonly SessionListItem[]>;
