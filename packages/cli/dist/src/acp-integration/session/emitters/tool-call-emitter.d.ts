...
import type { SessionEmitterContext, ToolCallStartParams, ToolCallResultParams, ResolvedToolMetadata, SubagentMeta } from '../types.js';
import type { ToolCallContent, ToolKind } from '@agentclientprotocol/sdk';
import { Kind } from '@lailatul-coder/lailatul-coder-core';
/**
...
export declare class ToolCallEmitter extends BaseEmitter {
     ...
     */
    static resolveToolProvenance(toolName: string, subagentMeta?: SubagentMeta): {
...
export declare function buildToolResultContentPrefix(resultDisplay: unknown): ToolCallContent[];
