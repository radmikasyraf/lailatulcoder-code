 ...
 */
import type { ResumedSessionData, Config } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export declare function buildResumedHistoryItems(sessionData: ResumedSessionData, config: Config | null, baseTimestamp?: number): HistoryItem[];
/**
 ...
 */
export declare function expandCollapsedHistory(items: HistoryItem[]): HistoryItem[];
/**
 * Helper to apply the collapse policy and append the summary item if needed.
 */
export declare function applyCollapsePolicyAndSummary(rawItems: HistoryItem[], collapseOnResume: boolean, collapsePreviewCount?: number): HistoryItem[];
