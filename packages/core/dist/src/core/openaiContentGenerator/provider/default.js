...
import { tokenLimit, hasExplicitOutputLimit, defaultOutputCeiling, parsePositiveIntegerEnvValue, } from '../../tokenLimits.js';
...
export class DefaultOpenAICompatibleProvider {
    ...
    buildClient() {
        const { apiKey, baseUrl, maxRetries = DEFAULT_MAX_RETRIES, } = this.contentGeneratorConfig;
