 ...
 */
import { SessionService, type SessionLocation } from '@lailatul-coder/lailatul-coder-core';
...
export declare function assertSessionLoadable(workspaceCwd: string, sessionId: string, runtimeBaseDir?: string): Promise<SessionLocation>;
export declare function assertSessionArchived(workspaceCwd: string, sessionId: string, runtimeBaseDir?: string): Promise<void>;
