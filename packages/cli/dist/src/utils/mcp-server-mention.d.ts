...
export declare function matchMcpServerByRef(name: string, servers: Record<string, MCPServerConfig>): {
    serverName: string;
    server: MCPServerConfig;
} | undefined;
export declare function buildMcpServerContextText(config: Config, serverName: string): string;
