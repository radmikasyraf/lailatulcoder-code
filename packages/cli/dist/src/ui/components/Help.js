...
const DOCS_URL = 'https://qwenlm.github.io/LailatulCoder-code-docs/';
...
const HelpTabs = ({ activeTab }) => (_jsxs(Box, { flexDirection: "row", children: [_jsx(Text, { bold: true, color: theme.text.accent, children: "LailatulCoder Ai" }), _jsx(Text, { color: theme.text.secondary, children: " " }), TAB_DEFS.map(({ tab, labelKey }) => {
