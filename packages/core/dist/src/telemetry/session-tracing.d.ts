...
export declare function endAllInteractionSpans(status?: InteractionStatus): void;
...
export declare function getActiveInteractionSpan(promptId?: string): Span | undefined;
export declare function recordInteractionActivity(promptId: string, expectedOwner: Span): boolean;
