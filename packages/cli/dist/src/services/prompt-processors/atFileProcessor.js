 ...
 */
import { flatMapTextParts, readPathFromWorkspace, createDebugLogger, } from '@lailatul-coder/lailatul-coder-core';
            ...
            for (const injection of injections) {
                ...
                try {
                    ...
                    if (fileContentParts.length === 0) {
                        const uiMessage = `File '@{${pathStr}}' was ignored by .gitignore or configured LailatulCoder ignore files and was not included in the prompt.`;
