...
class TeamDeleteInvocation extends BaseToolInvocation {
    ...
    async execute() {
        ...
        // directory and recreates `~/.lailatulcoder/teams/{name}/...` *after*
...
export class TeamDeleteTool extends BaseDeclarativeTool {
    ...
    constructor(config) {
        super(TeamDeleteTool.Name, ToolDisplayNames.TEAM_DELETE, 'Delete the current team. Stops all teammates, ' +
            'cleans up team files, tasks, and inboxes. ' +
            'Only the team leader can use this.', Kind.Delete, {
            type: 'object',
            properties: {},
