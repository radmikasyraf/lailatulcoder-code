 ...
 */
import type { Extension, Config, ExtensionScope } from '@lailatul-coder/lailatul-coder-core';
/**
 ...
 */
export declare const EXTENSIONS_TABS: {
    readonly DISCOVER: "discover";
    readonly INSTALLED: "installed";
    readonly SOURCES: "sources";
};
export type ExtensionsTab = (typeof EXTENSIONS_TABS)[keyof typeof EXTENSIONS_TABS];
