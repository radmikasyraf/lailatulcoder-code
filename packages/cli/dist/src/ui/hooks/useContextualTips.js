...
import { DEFAULT_TOKEN_LIMIT, computeThresholds, } from '@lailatul-coder/lailatul-coder-core';
...
export function useContextualTips({ streamingState, lastPromptTokenCount, sessionPromptCount, config, tipHistory, addItem, hideTips, }) {
    ...
    useEffect(() => {
        ...
        const tipContext = {
            ...
            thresholds: computeThresholds(contextWindowSize, config.getAutoCompactThreshold()),
        };
