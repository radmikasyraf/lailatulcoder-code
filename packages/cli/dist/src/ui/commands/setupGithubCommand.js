 ...
 */
import { GITHUB_WORKFLOW_PATHS, setupGithub, updateGitignore as updateGitignoreWithStatus, } from '../../services/setup-github.js';
...
export const setupGithubCommand = {
    ...
    action: async (context) => {
        ...
        commands.push(`echo "Successfully downloaded ${GITHUB_WORKFLOW_PATHS.length} workflows and updated .gitignore. Follow the steps in ${result.readmeUrl} (skipping the /setup-github step) to complete setup."`);
        ...
        return {
            ...
            toolArgs: {
                description: 'Setting up GitHub Actions to triage issues and review PRs with LailatulCoder.',
                command,
                is_background: false,
            },
        };
