 ...
 */
export function formatWorkspaceMemoryForgetSummary(removedEntryCount) {
...
export function formatWorkspaceMemoryDreamSummary(touchedTopicCount) {
    return touchedTopicCount > 0
        ? 'Managed auto-memory dream completed.'
        : 'No managed auto-memory topics changed.';
}
//# sourceMappingURL=workspace-memory-summaries.js.map