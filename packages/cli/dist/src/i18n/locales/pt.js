...
// Portuguese translations for LailatulCoder Ai CLI (pt-BR)
...
export default {
  ...
  'for help on LailatulCoder Ai': 'para ajuda sobre o LailatulCoder Ai',
  ...
  'Analyzes the project and creates a tailored LAILATUL.md file.':
    'Analisa o projeto e cria um arquivo LAILATUL.md personalizado.',
  'List available LailatulCoder Ai tools. Usage: /tools [desc]':
    'Listar ferramentas LailatulCoder Ai disponíveis. Uso: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.lailatulcoder/settings.json directly to manage skills at user scope.':
    'O espaço de trabalho não é confiável; as configurações do espaço de trabalho são ignoradas pela configuração combinada. Execute /trust primeiro, ou edite ~/.lailatulcoder/settings.json diretamente para gerenciar habilidades no escopo do usuário.',
  ...
  'All available skills are disabled. Edit ~/.lailatulcoder/settings.json or .lailatulcoder/settings.json (skills.disabled) to re-enable.':
    'Todas as habilidades disponíveis estão desativadas. Edite ~/.lailatulcoder/settings.json ou .lailatulcoder/settings.json (skills.disabled) para reativá-las.',
  ...
  'open full LailatulCoder Ai documentation in your browser':
    'abrir documentação completa do LailatulCoder Ai no seu navegador',
  ...
  'How is LailatulCoder doing this session? (optional)':
    'Como o LailatulCoder está se saindo nesta sessão? (opcional)',
  Bad: 'Ruim',
  Fine: 'Bom',
  Good: 'Ótimo',
  Dismiss: 'Ignorar',
  ...
  'Respect .lailatulcoderignore': 'Respeitar .lailatulcoderignore',
  ...
  'This extension will append info to your LAILATUL.md context using {{fileName}}':
    'Esta extensão anexará informações ao seu contexto LAILATUL.md usando {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with LailatulCoder Ai.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o LailatulCoder Ai.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run LailatulCoder Ai in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o LailatulCoder Ai em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage LailatulCoder Ai hooks': 'Gerenciar hooks do LailatulCoder Ai',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask LailatulCoder Ai.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao LailatulCoder Ai.',
  ...
  'To add hooks, edit settings.json directly or ask LailatulCoder.':
    'Para adicionar hooks, edite settings.json diretamente ou pergunte ao LailatulCoder.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask LailatulCoder to help.':
    'Para modificar ou remover este hook, edite settings.json diretamente ou pergunte ao LailatulCoder.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask LailatulCoder Ai.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao LailatulCoder Ai.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  Skill: 'Habilidade',
  ...
  'Right before LailatulCoder Ai concludes its response':
    'Logo antes do LailatulCoder Ai concluir sua resposta',
  ...
  'stdout shown to LailatulCoder': 'stdout mostrado ao LailatulCoder',
  ...
  'Generate a project summary and save it to .lailatulcoder/PROJECT_SUMMARY.md':
    'Gerar um resumo do projeto e salvá-lo em .lailatulcoder/PROJECT_SUMMARY.md',
  ...
  'Successfully added LAILATUL.md files from the following directories if there are:\n- {{directories}}':
    'Arquivos LAILATUL.md adicionados com sucesso dos seguintes diretórios, se houverem:\n- {{directories}}',
  ...
  'Run LailatulCoder --debug to see error logs':
    'Execute LailatulCoder --debug para ver os logs de erro',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'O nível gratuito do LailatulCoder Auth foi descontinuado em 2026-04-15. Selecione Coding Plan ou API Key.',
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'O nível gratuito do LailatulCoder Auth foi descontinuado em 2026-04-15. Por favor, selecione um modelo de outro provedor ou execute /auth para trocar.',
  '\n⚠ LailatulCoder Auth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ O nível gratuito do LailatulCoder Auth foi descontinuado em 2026-04-15. Selecione outra opção.\n',
  ...
  'LailatulCoder Auth Authentication': 'Autenticação LailatulCoder Auth',
  ...
  'LailatulCoder Auth Authentication Timeout':
    'Tempo Limite de Autenticação LailatulCoder Auth',
  ...
  'Waiting for LailatulCoder Auth authentication...':
    'Aguardando autenticação LailatulCoder Auth...',
  ...
  "LailatulCoder Ai won't ask before using allowed tools.":
    'O LailatulCoder Ai não perguntará antes de usar ferramentas permitidas.',
  'LailatulCoder Ai will ask before using these tools.':
    'O LailatulCoder Ai perguntará antes de usar essas ferramentas.',
  'LailatulCoder Ai is not allowed to use denied tools.':
    'O LailatulCoder Ai não tem permissão para usar ferramentas negadas.',
  ...
  'LailatulCoder Ai can read files in the workspace, and make edits when auto-accept edits is on.':
    'O LailatulCoder Ai pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'LailatulCoder Ai will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O LailatulCoder Ai poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from LailatulCoder Ai using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do LailatulCoder Ai usando ! (ex: !ls).',
  ...
  'You can resume a previous conversation by running lailatulcoder --continue or lailatulcoder --resume.':
    'Você pode retomar uma conversa anterior executando lailatulcoder --continue ou lailatulcoder --resume.',
  ...
  'Add a LAILATUL.md file to give LailatulCoder Ai persistent project context.':
    'Adicione um arquivo LAILATUL.md para dar ao LailatulCoder Ai um contexto persistente do projeto.',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: Navegar | Enter: Selecionar | Esc: Cancelar',
  'Authenticate using LailatulCoder Auth': 'Autenticar usando LailatulCoder Auth',
  ...
  'Starting LailatulCoder Auth authentication...':
    'Iniciando autenticação LailatulCoder Auth...',
  'Successfully authenticated with LailatulCoder Auth.':
    'Autenticado com sucesso via LailatulCoder Auth.',
  'Failed to authenticate with LailatulCoder Auth: {{error}}':
    'Falha ao autenticar com LailatulCoder Auth: {{error}}',
  ...
  '  LailatulCoder auth LailatulCoder-oauth     - Authenticate with LailatulCoder Auth (discontinued)':
    '  LailatulCoder auth LailatulCoder-oauth     - Autenticar com LailatulCoder Auth (descontinuado)',
  'Or simply run:': 'Ou simplesmente execute:',
  '  LailatulCoder auth                - Interactive authentication setup\n':
    '  LailatulCoder auth                - Configuração interativa de autenticação\n',
  '✓ Authentication Method: LailatulCoder Auth': '✓ Método de autenticação: LailatulCoder Auth',
  ...
  'LailatulCoder Auth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'O nível gratuito do LailatulCoder Auth foi descontinuado em 2026-04-15. Execute /auth para mudar para Coding Plan, OpenRouter, Fireworks AI ou outro provedor.',
  ...
  '  Run `LailatulCoder auth coding-plan` to re-configure.\n':
    '  Execute `LailatulCoder auth coding-plan` para reconfigurar.\n',
  ...
  "Set up LailatulCoder Ai's status line UI":
    'Configurar a interface da barra de status do LailatulCoder Ai',
  ...
  'Check for LailatulCoder Ai updates and install if available':
    'Verificar atualizações do LailatulCoder Ai e instalar se disponível',
  'LailatulCoder Ai update available! {{current}} → {{latest}}':
    'Atualização do LailatulCoder Ai disponível! {{current}} → {{latest}}',
  'A new version of LailatulCoder Ai is available! {{current}} → {{latest}}':
    'Uma nova versão do LailatulCoder Ai está disponível! {{current}} → {{latest}}',
  'LailatulCoder Ai {{version}} is up to date!':
    'LailatulCoder Ai {{version}} está atualizado!',
  ...
  'Update successful! Please restart LailatulCoder Ai to use the new version. Switching model providers before restarting may not work correctly.':
    'Atualização bem-sucedida! Reinicie o LailatulCoder Ai para usar a nova versão. Alternar provedores de modelo antes de reiniciar pode não funcionar corretamente.',
  ...
  'Manual update required. Please reinstall LailatulCoder Ai.':
    'Atualização manual necessária. Reinstale o LailatulCoder Ai.',
  'This session uses the custom sandbox image {{image}}. Update that image and restart LailatulCoder Ai.':
    'Esta sessão usa a imagem de sandbox personalizada {{image}}. Atualize a imagem e reinicie o LailatulCoder Ai.',
  'Update LailatulCoder Ai on the host, then restart the sandbox.':
    'Atualize o LailatulCoder Ai no host e reinicie o sandbox.',
