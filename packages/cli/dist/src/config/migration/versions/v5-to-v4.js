 ...
 * silently lossy.
 */
const PROVIDER_KEY_TO_PROTOCOL = {
    openai: 'openai',
    'LailatulCoder-oauth': 'LailatulCoder-oauth',
    gemini: 'gemini',
    'vertex-ai': 'gemini',
    anthropic: 'anthropic',
};
...
export class V5ToV4Migration {
    ...
    shouldMigrate(settings) {
        ...
        return Object.values(modelProviders).some((v) => isWrappedProviderConfig(v));
    }
        ...
        if (typeof modelProviders === 'object' && modelProviders !== null) {
            ...
            for (const [key, value] of Object.entries(providers)) {
                ...
                if (typeof value.protocol === 'string' &&
                    ...
                    warnings.push(`Provider "${key}" declared protocol "${value.protocol}", but V4 ` +
...
//# sourceMappingURL=v5-to-v4.js.map