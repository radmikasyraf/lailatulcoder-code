 ...
 */
export declare function normalizeResumedAgentDepth(value: number | undefined): number | undefined;
/**
 ...
 */
export declare function buildAgentTranscriptAttach(config: Config, agentId: string, extras?: Partial<AttachJsonlOptions>): AgentTranscriptAttachTarget;
