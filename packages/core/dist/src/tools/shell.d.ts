...
export declare const DEFAULT_SHELL_HEARTBEAT_INTERVAL_MS = 10000;
/**
...
export declare class ShellToolInvocation extends BaseToolInvocation<ShellToolParams, ToolResult> {
    ...
    private preparedSedEdit;
    private confirmedSedNewContent;
    private sedEditPreviewFailed;
    constructor(config: Config, params: ShellToolParams);
    private getSedEditInfo;
    private resolveSedFilePath;
    private checkSedPriorRead;
    private prepareSedEdit;
    private makeSedEditDisplay;
    private sedEditError;
    private sedEditCancelledResult;
    private waitForSedOperation;
    private executeSedEdit;
    ...
    execute(signal: AbortSignal, updateOutput?: (output: ToolResultDisplay) => void, shellExecutionConfig?: ShellExecutionConfig, setPidCallback?: (pid: number) => void, setPromoteAbortControllerCallback?: (ac: AbortController) => void, canPromoteForegroundShell?: () => boolean): Promise<ToolResult>;
    /**
