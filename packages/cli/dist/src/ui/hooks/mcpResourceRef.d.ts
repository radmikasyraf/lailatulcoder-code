 ...
 * stay in lockstep.
 */
export declare function matchMcpServerPrefix(input: string, serverNames: Iterable<string>): {
    serverName: string;
    rest: string;
} | null;
/**
 ...
 */
export declare function buildMcpResourceRef(serverName: string, uri: string): string;
