...
export function getVoiceUnavailableReason(environment = {
    ...
    if (platform === 'linux' &&
        ...
        return t('Voice dictation needs microphone access, which is unavailable in this WSL session. Use WSLg/PulseAudio, or run LailatulCoder Ai on a host with a microphone.');
    }
    return undefined;
}
