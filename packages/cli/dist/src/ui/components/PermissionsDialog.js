    ...
    return [
        {
            ...
            description: t('Checked in at .lailatulcoder/settings.json'),
            value: SettingScope.Workspace,
            key: 'project',
        },
        {
            label: t('User settings'),
            description: t('Saved in at ~/.lailatulcoder/settings.json'),
    ...
    return [
        {
            id: 'allow',
            label: t('Allow'),
            description: t("LailatulCoder Ai won't ask before using allowed tools."),
        },
        {
            id: 'ask',
            label: t('Ask'),
            description: t('LailatulCoder Ai will ask before using these tools.'),
        },
        {
            id: 'deny',
            label: t('Deny'),
            description: t('LailatulCoder Ai is not allowed to use denied tools.'),
        },
        {
            id: 'workspace',
            label: t('Workspace'),
