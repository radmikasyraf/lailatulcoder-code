 ...
 */
export declare function saveCacheSafeParams(generationConfig: GenerateContentConfig, history: Content[], model: string, sessionId?: string): void;
/**
...
export declare function getCacheSafeParamsSessionId(): string | undefined;
/**
