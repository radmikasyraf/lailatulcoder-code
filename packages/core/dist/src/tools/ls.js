        ...
        super(LSTool.Name, ToolDisplayNames.LS, 'Lists the names of files and subdirectories directly within a specified directory path. Can optionally ignore entries matching provided glob patterns.', Kind.Search, {
            properties: {
                ...
                file_filtering_options: {
                    description: 'Optional: Whether to respect ignore patterns from .gitignore, .lailatulcoderignore, and configured custom Qwen ignore files',
                    type: 'object',
                    properties: {
                        respect_git_ignore: {
                        ...
                        respect_qwen_ignore: {
                            description: 'Optional: Whether to respect .lailatulcoderignore and configured custom Qwen ignore file patterns when listing files. Defaults to true.',
                            type: 'boolean',
                        },
                    },
                },
