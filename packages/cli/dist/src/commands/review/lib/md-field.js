...
export function mdField(s) {
    const inner = String(s)
        ...
        // `stripLedgerMarker` takes the FIRST `<!-- LailatulCoder-review-ledger` it
        // finds — so a path named `a <!-- LailatulCoder-review-ledger .sh` (git permits
...
//# sourceMappingURL=md-field.js.map