...
import type { ContentGenerator, ContentGeneratorConfig, InputModalities } from '../core/contentGenerator.js';
...
import type { ArtifactHostConfig, ArtifactOssConfig } from '../tools/artifact/publisher.js';
import type { LspClient, LspServiceReinitializeResult, LspStatusSnapshot } from '../lsp/types.js';
...
import { ChatRecordingService, type ChatRecordingFailureListener } from '../services/chatRecordingService.js';
import { SessionService, type ResumedSessionData } from '../services/sessionService.js';
import type { SessionRestoreProjection, SessionRuntimeResumeState } from '../services/session-transcript-reader.js';
import { ConditionalRulesRegistry } from '../utils/rulesDiscovery.js';
import { type DebugLogger } from '../utils/debugLogger.js';
import { MemoryManager } from '../memory/manager.js';
import { ModelsConfig, type ModelProvidersConfig, type ProviderProtocolConfig, type AvailableModel, type ResolvedModelConfig, type RuntimeModelSnapshot } from '../models/index.js';
...
export type ModelInvocableCommandExecutorResult = string | {
    error: string;
};
...
export type ExtensionOriginSource = 'QwenCode' | 'Claude' | 'Gemini' | 'Qoder' | 'AgentPlugins';
export type ExtensionNetworkPolicy = 'public';
export interface ExtensionInstallMetadata {
    source: string;
    type: 'git' | 'local' | 'link' | 'github-release' | 'npm' | 'archive-url' | 'snapshot';
    installId?: string;
 ...
 */
export type McpServerUnavailableReason = 'removed' | 'not_allowed' | 'excluded' | 'pending_approval';
/**
 ...
 */
export declare function isGatedMcpScope(scope: McpServerScope | undefined): boolean;
/**
 ...
 */
export declare function matchesServerPattern(name: string, pattern: string): boolean;
/**
 * Test whether a server name matches any pattern in the given list.
 * Returns false for an empty or undefined list.
 */
export declare function matchesAnyServerPattern(name: string, patterns: string[] | undefined): boolean;
export declare class MCPServerConfig {
     ...
     * `new MCPServerConfig(...)` call sites. See issue #4615.
     */
    scope?: McpServerScope | undefined, alwaysLoadTools?: boolean | undefined, agentPluginV1?: boolean | undefined);
}
/**
...
export interface ConfigParameters {
    ...
    sessionRestoreProjectionSource?: () => Promise<SessionRestoreProjection | undefined>;
 ...
 */
export declare function normalizeMaxSubagentDepth(value: number | null | undefined): number;
/**
 * Validates the session-turn limit at config and persisted-agent boundaries.
 */
export declare function validateMaxSessionTurns(value: number | undefined): number;
/**
 ...
 */
export type SubSessionSpawner = (req: SubSessionSpawnRequest) => Promise<SubSessionSpawnResult>;
/**
...
export declare class Config {
    ...
    private sessionData?;
    private pendingSessionRestoreProjection?;
    private sessionRestoreRuntime?;
    private readonly sessionRestoreProjectionSource?;
    private restoredFileHistory;
    private goalRestoreActivation?;
    private rejectGoalRestoreActivation?;
    ...
    private loadedContextFilePaths;
    ...
    private readonly lsToolEnabled;
    ...
    private sessionRegistryWrite;
    private readonly fileExclusions;
    private readonly truncateToolOutputThreshold;
    private readonly truncateToolOutputThresholdExplicit;
    ...
    refreshHierarchicalMemory(loadReason?: Exclude<InstructionLoadReason, 'include'>): Promise<void>;
     ...
     */
    reloadModelProvidersConfig(modelProvidersConfig?: ModelProvidersConfig, providerProtocolConfig?: ProviderProtocolConfig): void;
    /**
    ...
    unregisterSessionRegistry(): Promise<void>;
     ...
     */
    private queueSessionRegistryWrite;
     ...
     * Delegates to ModelsConfig.
     */
    getResolvedModelConfig(authType: AuthType, modelId: string, baseUrl?: string): ResolvedModelConfig | undefined;
    /**
    ...
    relocateWorkingDirectory(newDir: string, expectedCanonicalDir?: string, opts?: {
    ...
    setMcpTransportPool(pool: import('../tools/mcp-transport-pool.js').McpTransportPool | undefined): void;
    getMcpTransportPool(): import('../tools/mcp-transport-pool.js').McpTransportPool | undefined;
    /**
     ...
     * - `pending_approval`: a gated server awaiting approval (#4615).
     */
    getMcpServerUnavailableReason(serverName: string): McpServerUnavailableReason | undefined;
    /**
     ...
     */
    reinitializeMcpServers(servers: Record<string, MCPServerConfig> | undefined): Promise<void>;
     ...
     */
    onTeamManagerChange(cb: ((manager: TeamManager | null) => void) | null, previous?: (manager: TeamManager | null) => void): void;
    ...
    setApprovalMode(mode: ApprovalMode, options?: {
    ...
    startAutomaticActiveTodoWorkChain(promptId: string, continuedFrom?: string): void;
    ...
    resolveImageGenerationModel(setting: string | undefined): ImageGenerationConfig | undefined;
    ...
    private clearSessionRestoreProjection;
    ...
    reviveCompletedBackgroundAgent(agentId: string, initialMessage?: string): Promise<import('../agents/background-tasks.js').AgentTask | undefined>;
     ...
     */
    setModelInvocableCommandsExecutor(executor: (name: string, args?: string) => Promise<ModelInvocableCommandExecutorResult | null>): void;
    /**
     * Returns the registered model-invocable commands executor, or null if none
     * has been registered (e.g., in SDK mode).
     */
    getModelInvocableCommandsExecutor(): ((name: string, args?: string) => Promise<ModelInvocableCommandExecutorResult | null>) | null;
    /**
