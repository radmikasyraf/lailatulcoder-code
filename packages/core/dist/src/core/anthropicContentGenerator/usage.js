 ...
 */
export function buildAnthropicUsageMetadata(parts) {
    const { inputTokens, cacheReadTokens, cacheCreationTokens, outputTokens } = parts;
    const looksLikeOpenAi = parts.cacheCreationTokensReported !== true &&
    ...
    setGenAiUsageProvenance(usage, {
        ...
        cacheCreationInputTokens: parts.cacheCreationTokensReported === true
            ? cacheCreationTokens
            : undefined,
    });
    return usage;
