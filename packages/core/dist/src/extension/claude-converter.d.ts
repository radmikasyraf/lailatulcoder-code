 ...
 */
export declare function resolvePluginRelativeFile(pluginSource: string, relativePath: string): string | null;
/**
 ...
 * conversion paths.
 */
export declare function buildQwenExtensionFromPlugin(pluginSource: string, mergedConfig: ClaudePluginConfig): Promise<{
    config: ExtensionConfig;
    convertedDir: string;
}>;
/**
