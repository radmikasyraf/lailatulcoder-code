...
import { type Suggestion, type SuggestionCategory } from '../utils/suggestions.js';
...
export declare function SuggestionsDisplay({ suggestions, activeIndex, isLoading, width, scrollOffset, userInput, mode, expandedIndex, onHoverIndex, onSelectIndex, mouseEnabled, activeCategory, availableCategories, }: SuggestionsDisplayProps): import("react").JSX.Element | null;
