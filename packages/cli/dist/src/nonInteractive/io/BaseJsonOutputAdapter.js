...
import { formatVisionBridgeNoticeDisplay, GeminiEventType, isVisionBridgeNoticeDisplay, ToolErrorType, parseAndFormatApiError, toolResultBoundaryArtifact, } from '@lailatul-coder/lailatul-coder-core';
...
export class BaseJsonOutputAdapter {
    ...
    emitToolResult(request, response, parentToolUseId = null) {
        ...
        if (content !== undefined && projectedContent !== undefined) {
            observeHeadlessToolResultProjection(message, content, projectedContent, request.callId, response.boundaryArtifact ??
