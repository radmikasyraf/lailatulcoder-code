...
const stderrSafe = vi.hoisted(() => vi.fn((message) => {
    try {
        stderr(message);
    }
    catch {
...
describe('operatorReviewSettings', () => {
    ...
    it('degrades to the safe defaults when the settings cannot be loaded', () => {
        ...
        expect(stderr).toHaveBeenCalledWith(expect.stringContaining('review settings could not be loaded'));
    });
...
//# sourceMappingURL=review-settings.test.js.map