 ...
 */
export declare function renderShellLayerBriefList(taxonomy?: readonly DefectLayer[]): string;
...
export declare const LAYER_RECEIPT_LINE_RE: RegExp;
/**
 ...
 * receipt authority.
 */
export declare const INLINE_LAYER_WALKED_RE: RegExp;
/**
 ...
 * USING it.
 */
export declare function parseLayerReceipts(finalText: string, taxonomy?: readonly DefectLayer[]): Set<string>;
/**
 ...
 */
export declare function inferLayersFromProse(finalText: string, taxonomy?: readonly DefectLayer[]): Set<string>;
 ...
 */
export declare function layerCoverage(finalTexts: readonly string[], opts?: {
    taxonomy?: readonly DefectLayer[];
    keywordFallback?: boolean;
}): LayerCoverage;
/** Ids no return covered — the short answer `layerCoverage` wraps. */
export declare function uncoveredLayers(finalTexts: readonly string[], opts?: {
    taxonomy?: readonly DefectLayer[];
    keywordFallback?: boolean;
}): string[];
/**
 ...
 * that filter runs).
 */
export declare function owedLayerDimensions(finalTexts: readonly string[], opts?: {
    taxonomy?: readonly DefectLayer[];
    keywordFallback?: boolean;
}): string[];
