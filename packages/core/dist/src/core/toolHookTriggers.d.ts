...
import { type NotificationType, type PermissionSuggestion, type PostToolBatchToolCall } from '../hooks/types.js';
 ...
 */
export declare function firePreToolUseHook(messageBus: MessageBus | undefined, toolName: string, toolInput: Record<string, unknown>, toolUseId: string, permissionMode: string, signal?: AbortSignal, tool_call_id?: string): Promise<PreToolUseHookResult>;
/**
 ...
 */
export declare function firePostToolUseHook(messageBus: MessageBus | undefined, toolName: string, toolInput: Record<string, unknown>, toolResponse: Record<string, unknown>, toolUseId: string, permissionMode: string, signal?: AbortSignal, tool_call_id?: string): Promise<PostToolUseHookResult>;
/**
 ...
 */
export declare function firePostToolUseFailureHook(messageBus: MessageBus | undefined, toolUseId: string, toolName: string, toolInput: Record<string, unknown>, errorMessage: string, isInterrupt?: boolean, permissionMode?: string, signal?: AbortSignal, tool_call_id?: string): Promise<PostToolUseFailureHookResult>;
/**
 ...
 */
export declare function firePostToolBatchHook(messageBus: MessageBus | undefined, toolCalls: PostToolBatchToolCall[], permissionMode?: string, signal?: AbortSignal): Promise<PostToolBatchHookResult>;
/**
