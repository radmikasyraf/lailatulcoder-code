import type { ObservedChannelContactGraph, ObservedChannelContactObservation } from '@lailatul-coder/channel-base';
...
export declare class ObservedChannelContactStore {
    ...
    observe(channelName: string, observation: ObservedChannelContactObservation): void;
