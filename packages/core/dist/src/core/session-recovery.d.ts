...
export type SessionRecoveryKind = 'clean' | 'interrupted_prompt' | 'interrupted_turn' | 'degraded_history';
...
export declare function buildSessionRecoveryPlan({ sessionId, conversation, historyGaps, options, }: BuildSessionRecoveryPlanInput): SessionRecoveryPlan;
export declare function buildSessionRecoveryPlanFromApiHistory({ sessionId, apiHistory: inputApiHistory, historyGaps, options, }: BuildSessionRecoveryPlanFromApiHistoryInput): SessionRecoveryPlan;
