...
export function formatSourceLabels(configs) {
    return Array.from(new Set(configs.map((config) => formatSourceLabel(config.source)))).join(', ');
}
...
//# sourceMappingURL=sourceLabels.js.map