...
export function useConfigInitMessage(isConfigInitialized) {
    ...
    useEffect(() => {
        ...
        const onChange = (clients) => {
            ...
            setMessage(t('Connecting to MCP servers... ({{connected}}/{{total}})', {
...
//# sourceMappingURL=useConfigInitMessage.js.map