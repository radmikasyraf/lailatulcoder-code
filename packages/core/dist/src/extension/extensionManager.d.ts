...
import { type ExtensionSource, type DiscoveredPlugin } from './sourceRegistry.js';
...
import { ExtensionStore, type ExtensionActivation, type ExtensionActivationResult, type ExtensionIdentity, type ExtensionStoreSnapshot, type InitialExtensionActivation, type WorkspaceActivation } from './extension-store.js';
import { type ExtensionGitCredential } from './extension-git-credentials.js';
...
export declare function isExtensionCommittedWithWarningsError(error: unknown): error is ExtensionCommittedWithWarningsError;
...
export declare class ExtensionNotUpdatableError extends Error {
...
export declare class ExtensionManager {
     ...
     */
    enableExtension(name: string, scope: SettingScope, cwd?: string, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    /**
     * Disables an extension at the specified scope.
     */
    disableExtension(name: string, scope: SettingScope, cwd?: string, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    getExtensionStoreSnapshot(): Promise<ExtensionStoreSnapshot>;
    getExtensionActivation(extensionId: string, workspacePath?: string): Promise<ExtensionActivationResult>;
    getExtensionActivationFromSnapshot(extensionId: string, snapshot: ExtensionStoreSnapshot, workspacePath?: string): ExtensionActivationResult;
    getExtensionActivationForIdentityFromSnapshot(identity: ExtensionIdentity, snapshot: ExtensionStoreSnapshot, workspacePath?: string): ExtensionActivationResult;
    getExtensionActivationForNameFromSnapshot(name: string, snapshot: ExtensionStoreSnapshot, workspacePath?: string): ExtensionActivationResult;
    setExtensionDefaultActivation(extensionId: string, activation: ExtensionActivation, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    setExtensionDefaultActivations(names: readonly string[], activation: ExtensionActivation, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    setExtensionActivationScope(extensionId: string, activation: InitialExtensionActivation, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    setExtensionWorkspaceActivation(extensionId: string, workspacePath: string, activation: ExtensionActivation, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    setExtensionWorkspaceActivations(names: readonly string[], workspacePath: string, activation: WorkspaceActivation, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    private resolveBatchExtensionIdentities;
    clearExtensionWorkspaceActivation(extensionId: string, workspacePath: string, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    ...
    loadExtension(context: LoadExtensionContext, options?: {
     ...
     */
    installExtension(installMetadata: ExtensionInstallMetadata, requestConsent?: (options?: ExtensionRequestOptions) => Promise<void>, requestSetting?: (setting: ExtensionSetting) => Promise<string>, cwd?: string, previousExtensionConfig?: ExtensionConfig, initialActivation?: InitialExtensionActivation, signal?: AbortSignal): Promise<Extension>;
    prepareExtensionInstall(options: PrepareExtensionInstallOptions): Promise<PreparedExtensionMutation>;
    ...
    commitPreparedExtension(prepared: PreparedExtensionMutation, onCommitted?: ExtensionCommitCallback): Promise<CommittedExtensionMutation>;
     ...
     */
    uninstallExtension(extensionIdentifier: string, isUpdate: boolean, cwd?: string, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    uninstallExtensionById(extensionId: string, isUpdate: boolean, cwd?: string, onCommitted?: ExtensionCommitCallback): Promise<ExtensionStoreMutationResult>;
    ...
    checkForAllExtensionUpdates(callback: (extensionName: string, state: ExtensionUpdateState) => void, signal?: AbortSignal, schedule?: <T>(task: () => Promise<T>) => Promise<T>): Promise<void>;
    updateExtension(extension: Extension, currentState: ExtensionUpdateState, callback: (extensionName: string, state: ExtensionUpdateState) => void, enableExtensionReloading?: boolean, signal?: AbortSignal): Promise<ExtensionUpdateInfo | undefined>;
...
export declare function copyExtension(source: string, destination: string, options?: {
