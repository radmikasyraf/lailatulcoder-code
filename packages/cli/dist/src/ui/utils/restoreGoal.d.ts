 ...
 */
import { type Config, type GoalRecoveryRecord, type GoalTerminalEvent } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export declare function collectGoalStatusItemsFromRecords(records: readonly GoalRecoveryRecord[]): GoalStatusItem[];
