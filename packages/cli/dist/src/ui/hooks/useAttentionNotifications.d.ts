...
export declare const useAttentionNotifications: ({ isFocused, streamingState, elapsedTime, settings, config, terminal, pendingToolCalls, }: UseAttentionNotificationsOptions) => void;
export {};
