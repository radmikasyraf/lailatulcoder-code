 ...
 */
import { WorkspaceMcpBudget, type Config, type McpBudgetEvent, type ChatRecord, type ToolInvocationGuard } from '@lailatul-coder/lailatul-coder-core';
 ...
 */
export declare function createManagedExternalToolGuard(connection: AgentSideConnection, options?: {
    externalProviderAttached: boolean;
}): ToolInvocationGuard;
