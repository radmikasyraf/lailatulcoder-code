...
export declare function TextEntryStep({ state, dispatch, onNext, description, placeholder, height, initialText, onChange, validate, }: TextEntryStepProps): import("react").JSX.Element;
export {};
