 ...
 */
export function resetWarningHandlerForTests() {
    if (installedHandler) {
 ...
 */
export function initializeWarningHandler() {
    if (installedHandler)
        return;
    ...
    const priorListeners = [...process.listeners('warning')];
    installedHandler = (warning) => {
        ...
        if (!isDebugMode() && isSuppressed(warning))
            return;
...
//# sourceMappingURL=warningHandler.js.map