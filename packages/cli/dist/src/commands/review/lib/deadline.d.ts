 ...
 */
export declare function claimRetirementDegradeNote(planPath: string, round: number | undefined): boolean;
/**
 ...
 * process it runs in.
 */
export declare function hasReviewDeadline(env: NodeJS.ProcessEnv): boolean;
/**
 ...
 *  phrase. */
export declare const BUDGET_STOP_PHRASE_ZH = "\u8BC4\u5BA1\u65F6\u95F4\u9884\u7B97";
/**
...
export declare const ROUND_CAP_PHRASE_ZH = "\u53CD\u5BA1\u8F6E\u6570\u4E0A\u9650";
/**
 ...
 */
export declare function readBudgetStopUnfenced(planPath: string): BudgetStop | null;
/**
 ...
 */
export declare function clearRoundStamps(planPath: string): void;
/**
