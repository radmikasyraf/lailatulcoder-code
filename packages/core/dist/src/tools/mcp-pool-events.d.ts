 ...
 * subscribers.
 */
export type PoolEntryState = 'spawning' | 'active' | 'draining' | 'closed' | 'failed';
/**
 ...
 */
export declare class MCPCallInterruptedError extends Error {
    readonly name = "MCPCallInterruptedError";
    ...
    constructor(serverName: string, entryIndex: number, clientGeneration: number, args: unknown, message?: string);
}
